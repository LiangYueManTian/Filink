...
public class LogFeignFallback implements LogFeign {
    ...
    public Result addOperateLog(AddOperateLogReq operateLogReq) {
        ...
        try {
            ...
            logger.warn("Add operate log error before exec method", e);
        }
        String addOperateLogError = "Add operate log error";
    ...
    public Result addSecurityLog(AddSecurityLogReq securityLogReq) {
        try {
            ...
            logger.warn("Add security log error before exec method", e);
        }
        String addSecurityLogError = "Add security log error";
    ...
    public Result addSystemLog(AddSystemLogReq systemLogReq) {
        try {
            ...
            logger.warn("Add system log error before exec method", e);
        }
        String addSystemLogInfo = "Add system log error";
