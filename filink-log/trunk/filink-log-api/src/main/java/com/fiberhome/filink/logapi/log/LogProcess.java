...
public class LogProcess {
    ...
    public static LoginUserBean getLoginUserBeanInfo() {
        ...
        retLoginUser.setRoleId(ObjectUtils.isEmpty(roleId) ? "system" : roleId);
        retLoginUser.setRoleName(ObjectUtils.isEmpty(roleName) ? "system" : roleName);
        retLoginUser.setUserId(ObjectUtils.isEmpty(userId) ? "system" : userId);
        retLoginUser.setUserName(ObjectUtils.isEmpty(userName) ? "system" : userName);
        return retLoginUser;
    }
}
