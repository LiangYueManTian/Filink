...
public class LogCastProcess {
     ...
     * 系统语言配置文件名称
     */
    public static final String SYSTEM_LANGUAGE_UTIL = "systemLanguageUtil";
    ...
    public String getLanguage() {
        String language = "";
        try {
            Object languageObject = webApplicationConnect.getBean(LogCastProcess.SYSTEM_LANGUAGE_UTIL);
            Field languageField = languageObject.getClass().getDeclaredField(LogCastProcess.SYSTEM_LANGUAGE);
