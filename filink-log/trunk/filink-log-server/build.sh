...
# author yaoyuan
# desc: 构建docker镜像
_jarPath=/root/.jenkins/workspace/filink-log/filink-log-server/target/filink-log-server-0.0.1-RELEASE.jar
_imageName=filink-log-server
_imageTag=filink-log
_projectName=filink-log
if [[ -f ${_jarPath} ]]
