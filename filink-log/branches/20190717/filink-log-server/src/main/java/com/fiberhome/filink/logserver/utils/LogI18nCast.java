...
public class LogI18nCast {
    ...
    public static String getDangerLevel(Integer dangerLevel) {
        ...
        if (LogConstants.DANGER_LEVEL_PROMPT.equals(dangerLevel)) {
            //危险级别提示
            dangerLevelName = I18nUtils.getSystemString(I18nConstants.DANGER_LEVEL_PROMPT);
        } else if (LogConstants.DANGER_LEVEL_DANGER.equals(dangerLevel)) {
            //危险级别危险
            dangerLevelName = I18nUtils.getSystemString(I18nConstants.DANGER_LEVEL_DANGER);
        } else if (LogConstants.DANGER_LEVEL_GENERAL.equals(dangerLevel)) {
            //危险级别一般
            dangerLevelName = I18nUtils.getSystemString(I18nConstants.DANGER_LEVEL_GENERAL);
        }
    ...
    public static String getOptType(String optType) {
        ...
        if (LogConstants.OPT_TYPE_PDA.equals(optType)) {
            //PDA操作日志
            optTypeName = I18nUtils.getSystemString(I18nConstants.LOG_OPT_TYPE_PDA);
        } else if (LogConstants.OPT_TYPE_WEB.equals(optType)) {
            //网管操作日志
            optTypeName = I18nUtils.getSystemString(I18nConstants.LOG_OPT_TYPE_WEB);
        }
        return optTypeName;
    }
    ...
    public static String getOptResult(String optResult) {
        ...
        if (LogConstants.OPT_RESULT_SUCCESS.equals(optResult)) {
            //操作成功
            optResultName = I18nUtils.getSystemString(I18nConstants.OPT_RESULT_SUCCESS);
        } else if (LogConstants.OPT_RESULT_FAILURE.equals(optResult)) {
            //网管操作日志
            optResultName = I18nUtils.getSystemString(I18nConstants.OPT_RESULT_FAILURE);
        }
