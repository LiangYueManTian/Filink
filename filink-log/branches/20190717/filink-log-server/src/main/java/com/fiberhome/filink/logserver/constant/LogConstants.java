...
public class LogConstants {
     ...
     * 危险级别提示
     */
    public static final Integer DANGER_LEVEL_PROMPT = 1;

    /**
     * 危险级别一般
     */
    public static final Integer DANGER_LEVEL_GENERAL = 2;

    /**
     * 危险级别危险
     */
    public static final Integer DANGER_LEVEL_DANGER = 3;
     ...
     * 操作结果成功
     */
    public static final String OPT_RESULT_SUCCESS = "success";

    /**
     * 操作结果失败
     */
    public static final String OPT_RESULT_FAILURE = "failure";
