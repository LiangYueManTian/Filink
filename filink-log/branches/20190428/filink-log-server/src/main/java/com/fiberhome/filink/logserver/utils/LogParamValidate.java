...
public class LogParamValidate {
    ...
    public static Result checkOptName(String optName) {
        ...
        if (!LogParamValidate.checkObject(optName, optNameMinLength, optNameMaxLength)) {
            //提示操作名称校验错误
            return ResultUtils.warn(LogResultCode.OPT_NAME_IS_WRONG, I18nUtils.getString(I18nConstants.OPT_NAME_IS_WRONG));
        }
        return null;
    }
    ...
    public static Result checkOptUserCode(String optUserCode) {
        ...
        if (!LogParamValidate.checkObject(optUserCode, optUserCodeMinLength, optUserCodeMaxLength)) {
            //提示操作用户校验错误
            return ResultUtils.warn(LogResultCode.OPT_USER_CODE_IS_WRONG, I18nUtils.getString(I18nConstants.OPT_USER_CODE_IS_WRONG));
        }
        return null;
    }
    ...
    public static Result checkOptTime(Long optTime) {
        if (ObjectUtils.isEmpty(optTime)) {
            //提示操作时间校验错误
            return ResultUtils.warn(LogResultCode.OPT_TIME_IS_WRONG, I18nUtils.getString(I18nConstants.OPT_TIME_IS_WRONG));
        }
        return null;
    }
    ...
    public static Result checkOptTerminal(String optTerminal) {
        if (!ValidateUtils.validateDataInfoIsEmpty(optTerminal)) {
            //提示操作终端校验错误
            return ResultUtils.warn(LogResultCode.OPT_TERMINAL_IS_WRONG, I18nUtils.getString(I18nConstants.OPT_TERMINAL_IS_WRONG));
        }
        return null;
    }
    ...
    public static Result checkOptObj(String optObj) {
        ...
        if (!LogParamValidate.checkObject(optObj, optObjMinLength, optObjMaxLength)) {
            //提示操作对象校验错误
            return ResultUtils.warn(LogResultCode.OPT_OBJ_IS_WRONG, I18nUtils.getString(I18nConstants.OPT_OBJ_IS_WRONG));
        }
        return null;
    }
    ...
    public static Result checkOptResult(String optResult) {
        ...
        if (!LogParamValidate.checkObject(optResult, optResultMinLength, optResultMaxLength)) {
            //提示操作结果校验错误
            return ResultUtils.warn(LogResultCode.OPT_RESULT_IS_WRONG, I18nUtils.getString(I18nConstants.OPT_RESULT_IS_WRONG));
        }
        return null;
    }
    ...
    public static Result checkDetailInfo(String detailInfo) {
        ...
        if (!LogParamValidate.checkObject(detailInfo, detailInfoMinLength, detailInfoMaxLength)) {
            //提示详细信息校验错误
            return ResultUtils.warn(LogResultCode.DETAIL_INFO_IS_WRONG, I18nUtils.getString(I18nConstants.DETAIL_INFO_IS_WRONG));
        }
        return null;
    }
    ...
    public static Result checkDangerLevel(Integer dangerLevel) {
        if (ObjectUtils.isEmpty(dangerLevel)) {
            //提示危险级别校验错误
            return ResultUtils.warn(LogResultCode.DANGER_LEVEL_IS_WRONG, I18nUtils.getString(I18nConstants.DANGER_LEVEL_IS_WRONG));
        }
        return null;
    }
