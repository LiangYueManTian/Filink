...
public class LogConstants {
     ...
     * 默认用户中文名
     */
    public static final String DEFAULT_USER_NAME_CN = "系统管理员";

    /**
     * 默认用户英文名
     */
    public static final String DEFAULT_USER_NAME_US = "system manager";
     ...
     * 默认角色中文名称
     */
    public static final String DEFAULT_ROLE_NAME_CN = "系统管理员";

    /**
     * 默认角色英文名称
     */
    public static final String DEFAULT_ROLE_NAME_US = "system manager";
