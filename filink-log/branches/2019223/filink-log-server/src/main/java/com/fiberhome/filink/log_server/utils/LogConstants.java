...
public class LogConstants {
     ...
     * 危险级别提示
     */
    public static final String DANGER_LEVEL_PROMPT = "prompt";

    /**
     * 危险级别一般
     */
    public static final String DANGER_LEVEL_GENERAL = "general";

    /**
     * 危险级别危险
     */
    public static final String DANGER_LEVEL_DANGER = "danger";
