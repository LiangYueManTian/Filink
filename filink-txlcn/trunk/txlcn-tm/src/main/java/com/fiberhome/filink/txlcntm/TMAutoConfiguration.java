...
import com.fiberhome.filink.txlcncommon.runner.TxLcnApplicationRunner;
import com.fiberhome.filink.txlcncommon.util.ApplicationInformation;
import com.fiberhome.filink.txlcncommon.util.id.ModIdProvider;
import com.fiberhome.filink.txlcnlogger.TxLoggerConfiguration;
import com.fiberhome.filink.txlcntm.config.TxManagerConfig;
import com.fiberhome.filink.txlcntm.core.storage.FastStorage;
import com.fiberhome.filink.txlcntm.core.storage.FastStorageProvider;
import com.fiberhome.filink.txlcntm.core.storage.redis.RedisStorage;
import com.fiberhome.filink.txlcntxmsgnetty.MessageConfiguration;
...
@EnableJpaRepositories("com.fiberhome.filink.txlcntm.support.db.jpa")
@EntityScan("com.fiberhome.filink.txlcntm.support.db.domain")
