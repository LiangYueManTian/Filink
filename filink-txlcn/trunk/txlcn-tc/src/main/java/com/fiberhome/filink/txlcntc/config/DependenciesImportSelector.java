 ...
 */
package com.fiberhome.filink.txlcntc.config;

import com.fiberhome.filink.txlcntc.core.transaction.txc.TxcConfiguration;
...
public class DependenciesImportSelector implements ImportSelector {
    ...
    public String[] selectImports(@NonNull AnnotationMetadata importingClassMetadata) {
        ...
        importClasses.add("com.fiberhome.filink.txlcntxmsgnetty.MessageConfiguration");
        if (enabledTxc) {
