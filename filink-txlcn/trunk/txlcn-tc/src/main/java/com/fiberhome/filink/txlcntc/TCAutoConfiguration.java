 ...
 */
package com.fiberhome.filink.txlcntc;
...
import com.fiberhome.filink.txlcntracing.TracingAutoConfiguration;
...
@ComponentScan(
        excludeFilters = @ComponentScan.Filter(
                type = FilterType.ASPECTJ, pattern = "com.fiberhome.filink.txlcntc.core.transaction.txc..*"
        )
)
