 ...
 */
package com.fiberhome.filink.txlcntc.support.p6spy.common;
...
public class P6Util {
    ...
    /**
     * @param properties to be converted to {@link Map}.
    ...
    /**
     * @param collection to be joined elements.
     * @param separator  used in join.
