 ...
 */
package com.fiberhome.filink.txlcntc.aspect;

import com.fiberhome.filink.txlcncommon.util.Transactions;
import com.fiberhome.filink.txlcntc.annotation.DTXPropagation;
import com.fiberhome.filink.txlcntc.annotation.ITxTransaction;
import com.fiberhome.filink.txlcntc.annotation.LcnTransaction;
import com.fiberhome.filink.txlcntc.annotation.TccTransaction;
import com.fiberhome.filink.txlcntc.annotation.TxTransaction;
import com.fiberhome.filink.txlcntc.annotation.TxcTransaction;
import com.fiberhome.filink.txlcntc.aspect.weave.DTXLogicWeaver;
import com.fiberhome.filink.txlcntc.config.TxClientConfig;
...
public class TransactionAspect implements Ordered {
     ...
     */
    @Pointcut("@annotation(com.fiberhome.filink.txlcntc.annotation.TxTransaction)")
     ...
     */
    @Pointcut("@annotation(com.fiberhome.filink.txlcntc.annotation.LcnTransaction)")
     ...
     */
    @Pointcut("@annotation(com.fiberhome.filink.txlcntc.annotation.TxcTransaction)")
     ...
     */
    @Pointcut("@annotation(com.fiberhome.filink.txlcntc.annotation.TccTransaction)")
    ...
    @Around("this(com.fiberhome.filink.txlcntc.annotation.ITxTransaction) && execution( * *(..))")
