...
# author yaoyuan
# desc: 构建docker镜像
_jarPath=/root/.jenkins/workspace/filink-schedule/filink-schedule-server/target/filink-schedule-server-0.0.1-RELEASE.jar
_imageName=filink-schedule-server
_imageTag=filink-schedule
_projectName=filink-schedule
if [[ -f ${_jarPath} ]]
