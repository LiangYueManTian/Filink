...
public interface ScheduleStreams {
     ...
     * 增量统计
     */
    String FILINK_ALARM_INCREMENTAL = "filink_alarm_incremental";

    /**
     * 增量周统计
     */
    String FILINK_ALARM_WEEK_INCREMENTAL = "filink_alarm_week_incremental";

    /**
     * 增量月统计
     */
    String FILINK_ALARM_MONTH_INCREMENTAL = "filink_alarm_month_incremental";
     ...
     * @return 返回结果
     */
    @Output(FILINK_ALARM_INCREMENTAL)
    MessageChannel incrementalOutput();

    /**
     * 任务中心消息输出通道
     * @return 返回结果
     */
    @Output(FILINK_ALARM_WEEK_INCREMENTAL)
    MessageChannel incrementalWeekOutput();
     ...
     * @return 返回结果
     */
    @Output(FILINK_ALARM_MONTH_INCREMENTAL)
    MessageChannel incrementalMonthOutput();
