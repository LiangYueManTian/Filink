 ...
 */
@Slf4j
public class ProcCountYearStatisticalJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        scheduleStreams.yearProcCountOutput().send(msg);
        addLogByProcAdd();
    }
    ...
    private void addLogByProcAdd() {
        ...
        addLogBean.setOptObj(systemLanguageUtil.getI18nString(ScheduleI18nConstant.PROC_ADD_YEAR_STATISTICAL));
        addLogBean.setFunctionCode(LogFunctionCodeConstant.PROC_YEAR_ADD_FUNCTION_CODE);
        //新增系统日志
