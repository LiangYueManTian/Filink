 ...
 */
@Slf4j
public class ProcCountMonthStatisticalJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        scheduleStreams.monthProcCountOutput().send(msg);
        addLogByProcAdd();
    }
    ...
    private void addLogByProcAdd() {
        ...
        addLogBean.setFunctionCode(LogFunctionCodeConstant.PROC_MONTH_ADD_FUNCTION_CODE);
        //新增系统日志
