package com.fiberhome.filink.schedule_server.bean;
...
import com.fiberhome.filink.schedule_server.enums.JobTriggerEnum;
import lombok.Data;
...
public class TaskInfo {
     ...
     * @param tClass
     */
    public TaskInfo(Class<? extends QuartzJobBean> tClass) {
        this.tClass = tClass;
    }
