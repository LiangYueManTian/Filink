 ...
 */
@Slf4j
public class AlarmSourceIncrementalJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        Message msg = MessageBuilder.withPayload(INCREMENTAL_EXPIRE).build();
        scheduleStreams.alarmSourceIncremental().send(msg);
        log.info("告警增量日统计正常开始执行");
    }
}
