 ...
 */
@Slf4j
public class ProcCountStatisticalJob extends QuartzJobBean {
    ...
    private void addLogByProcAdd() {
        ...
        addLogBean.setOptObj(systemLanguageUtil.getI18nString(ScheduleI18nConstant.PROC_DAY_ADD_STATISTICAL));
        addLogBean.setFunctionCode(LogFunctionCodeConstant.PROC_DAY_ADD_FUNCTION_CODE);
        //新增系统日志
