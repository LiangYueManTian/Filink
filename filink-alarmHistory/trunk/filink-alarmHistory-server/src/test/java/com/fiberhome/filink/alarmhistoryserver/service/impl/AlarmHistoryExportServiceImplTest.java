...
public class AlarmHistoryExportServiceImplTest {
    ...
    public void exportAlarmList() throws Exception {
        ...
        Assert.assertTrue(result2.getCode() == AlarmHistoryResultCode.EXPORT_NO_DATA);
        new Expectations() {
            {
        ...
        Assert.assertTrue(result1.getCode() == AlarmHistoryResultCode.EXPORT_DATA_TOO_LARGE);
        new Expectations() {
            {
                alarmHistoryExport.insertTask((ExportDto) any, anyString, anyString);
        ...
        Assert.assertTrue(result3.getCode() == AlarmHistoryResultCode.EXCEED_THE_MAXIMUM_NUMBER_OF_TASKS);
        new Expectations() {
            {
                alarmHistoryExport.insertTask((ExportDto) any, anyString, anyString);
        ...
        Assert.assertTrue(result4.getCode() == AlarmHistoryResultCode.FAILED_TO_CREATE_EXPORT_TASK);
    }
