...
import com.fiberhome.filink.alarmhistoryserver.constant.AlarmHistoryConstant;
...
public class AlarmHistory {
    ...
    public String getTranslationAlarmContinousTime() {
        double continousTime;
        String continousTimeStr = "";
        if (this.alarmCleanTime != null && this.alarmCleanTime > 0) {
        ...
        } else if (time >= AlarmHistoryConstant.ALARM_BQLO) {
            // 年
        ...
        } else if (time >= AlarmHistoryConstant.ALARM_QLO) {
            // 月
        ...
        } else if (AlarmHistoryConstant.ALARM_ES <= time) {
            // 天
    ...
    public String getTranslationAlarmConfirmStatus() {
        return AlarmHistoryConstant.ALARM_STATUS_ONE == alarmConfirmStatus
