...
public class AlarmHistoryController {
    ...
    public Result queryAlarmHistoryList(@RequestBody QueryCondition<AlarmHistoryEs> queryCondition) {
        if (queryCondition == null || queryCondition.getFilterConditions() == null
                || queryCondition.getPageCondition() == null) {
            return ResultUtils.warn(AlarmHistoryResultCode.INCORRECT_PARAMETER,
    ...
    public Result insertAlarmHistoryListFeign(@RequestBody List<AlarmHistory> alarmHistoryList) {
        if (ListUtil.isEmpty(alarmHistoryList)) {
            return null;
        }
        return alarmHistoryService.insertAlarmHistoryList(alarmHistoryList);
    }
