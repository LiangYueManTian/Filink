...
public interface AlarmHistoryService extends IService<AlarmHistory> {
     ...
     * @return 历史告警列表信息
     */
    PageBean queryAlarmHistoryList(QueryCondition<AlarmHistoryEs> queryCondition);
     ...
     * @return 历史告警列表信息
     */
    PageBean queryAlarmHistoryListExport(QueryCondition<AlarmHistory> queryCondition);
    /**
     * 查询单个历史告警的信息
     *
     * @param alarmId 告警id
     ...
     * @return 判断结果
     */
    Result insertAlarmHistoryList(List<AlarmHistory> alarmHistoryList);
