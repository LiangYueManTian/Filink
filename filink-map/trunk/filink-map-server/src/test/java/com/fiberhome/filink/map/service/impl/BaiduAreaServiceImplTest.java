...
public class BaiduAreaServiceImplTest {
    ...
    public void querySonAreaByName() {
        ...
        new Expectations() {
            {
                baiduAreaDao.querySonAreaByName((BaiduArea) any);
                result = null;
            }
        };
        try {
            baiduAreaService.querySonAreaByName(new BaiduArea());
        } catch (Exception e) {
            Assert.assertTrue(e.getClass() == MapSystemException.class);
        }
        ...
        new Expectations() {
            {
                baiduAreaDao.querySonAreaByName(new BaiduArea());
                result = baiduArea;
            }
        };
        Result result = baiduAreaService.querySonAreaByName(new BaiduArea());
        Assert.assertTrue(result.getCode() == 0);
    }
    ...
    public void queryAllProvince() {
        ...
        Result result = baiduAreaService.queryAllProvince();
        Assert.assertTrue(result.getCode() == 0);
    }
    ...
    public void queryAllCityInfo() {
        ...
        Result result = baiduAreaService.queryAllCityInfo();
        Assert.assertTrue(result.getCode() == 0);
    }
