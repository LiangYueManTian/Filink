...
public class MapExceptionHandler {
    ...
    public Result handlerMapSystemException(MapSystemException ex) {
        log.error(I18nUtils.getSystemString(MapI18n.MAP_SYSTEM_ERROR));
        ex.printStackTrace();
        return ResultUtils.warn(MapResultCode.MAP_SYSTEM_ERROR,I18nUtils.getSystemString(MapI18n.MAP_SYSTEM_ERROR));
    }
    ...
    public Result handlerMapParamsException(MapParamsException ex) {
        log.error(I18nUtils.getSystemString(MapI18n.MAP_PARAMS_ERROR));
        ex.printStackTrace();
        return ResultUtils.warn(MapResultCode.MAP_PARAMS_ERROR,I18nUtils.getSystemString(MapI18n.MAP_PARAMS_ERROR));
    }
}
