...
public class BaiduAreaServiceImpl extends ServiceImpl<BaiduAreaDao, BaiduArea> implements BaiduAreaService {
     ...
     */
    @Override
    public Result querySonAreaByName(BaiduArea baiduArea) {
        List<BaiduArea> baiduAreas = baiduAreaDao.querySonAreaByName(baiduArea);
    ...
    public Result updateAreaById(BaiduArea area) {
        ...
        if (null != result && 1 == result) {
            return ResultUtils.success(ResultCode.SUCCESS, I18nUtils.getSystemString(MapI18n.MAP_UPDATE_SUCCESS));
        } else {
            throw new MapSystemException();
        }
