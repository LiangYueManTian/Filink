...
public class StationUtil {
    ...
    public static void deletePicMap(String equipmentId) {
        try {
            ...
            Map<String, Map<String, String>> adviseMap = (Map) RedisUtils.hGetMap(adviseKey);
     ...
     * @param equipmentId 主控id
     */
    private static void clearDevice(String equipmentId) {
        try {
            RedisUtils.hRemove(RedisKey.DEVICE_KEY, equipmentId);
        } catch (Exception e) {
            log.error("clear device port and ip failed : {}", e.getMessage());
        }
    }
