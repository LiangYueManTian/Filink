...
# author yaoyuan
# desc: 构建docker镜像
_jarPath=/root/.jenkins/workspace/filink-station/filink-station-server/target/filink-station-server-0.0.1-RELEASE.jar
_imageName=filink-station-server
_imageTag=filink-station
_projectName=filink-station
if [[ -f ${_jarPath} ]]
