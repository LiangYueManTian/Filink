...
@Component
@Slf4j
public class AlarmMonthStatisticsListen {
     ...
     * @param code 消息码
     */
    @StreamListener(AlarmChannel.INCREMENTAL_MONTH_STATISTICSLISTEN)
    public void incrementalStatisticsListen(String code) {

        if (AppConstant.INCREMENTAL_MONTH_STATISTICSLISTEN.equals(code)) {
