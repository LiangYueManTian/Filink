...
import com.fiberhome.filink.alarmcurrentserver.controller.PerformanceTest;
    ...
    public void alarmMsg(Map alarmMsgMap) {
        try {
            if (null != alarmMsgMap.get(AlarmCurrent18n.PARAMS)) {
                ...
                //todo 告警测试
                PerformanceTest.setAlarmTime(alarmMsgList.get(0).getEquipmentId(), "alarmRecvTime", System.currentTimeMillis());
                //遍历告警信息
