...
public class AlarmStatisticsServiceImplTest {
    ...
    public void alarmIncrementalStatistics() throws Exception {
        ...
        alarmQueryTemplateDto.setTopCount(10);
        queryCondition.setBizCondition(alarmQueryTemplateDto);
        alarmStatisticsService.alarmIncrementalStatistics(queryCondition, AppConstant.DAY, false);
        alarmStatisticsService.alarmIncrementalStatistics(queryCondition, AppConstant.WEEK, false);
        alarmStatisticsService.alarmIncrementalStatistics(queryCondition, AppConstant.MONTH, false);
    }
    ...
    public void queryAlarmSourceIncremental() throws Exception {
        ...
        AlarmSourceHomeParameter sourceHomeParameter = new AlarmSourceHomeParameter();
        sourceHomeParameter.setType("WEEK");
        sourceHomeParameter.setEndTime(111111111111111111L);
        sourceHomeParameter.setBeginTime(111111111111111111L);
        try {
            alarmStatisticsService.queryAlarmSourceIncremental(sourceHomeParameter);
        } catch (Exception e) {
