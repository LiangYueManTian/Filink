...
public class AlarmCurrentExportServiceImplTest {
    ...
    public void exportAlarmList() throws Exception {
        ...
        Assert.assertTrue(result2.getCode() == AlarmCurrentResultCode.EXPORT_NO_DATA);
        new Expectations() {
            {
        ...
        Assert.assertTrue(result1.getCode() == AlarmCurrentResultCode.EXPORT_DATA_TOO_LARGE);
        new Expectations() {
            {
                alarmCurrentExport.insertTask((ExportDto) any, anyString, anyString);
        ...
        Assert.assertTrue(result3.getCode() == AlarmCurrentResultCode.EXCEED_THE_MAXIMUM_NUMBER_OF_TASKS);
        new Expectations() {
            {
                alarmCurrentExport.insertTask((ExportDto) any, anyString, anyString);
        ...
        Assert.assertTrue(result4.getCode() == AlarmCurrentResultCode.FAILED_TO_CREATE_EXPORT_TASK);
    }
    ...
    public void updateAlarmCleanStatusCompensation() {
        new Expectations() {
            {
                alarmSetFeign.queryAlarmHistorySetFeign();;
                result = 1;
            }
        };
