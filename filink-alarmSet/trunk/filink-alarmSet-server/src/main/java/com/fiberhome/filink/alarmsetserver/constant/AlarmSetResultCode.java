 ...
 * @since 2019-01-22
 */
public class AlarmSetResultCode extends ResultCode {
     ...
     * 该颜色已被使用
     */
    public static final Integer COLOR_USED = 170123;

    /**
     * 参数不正确
     */
    public static final Integer INCORRECT_PARAMETER = 170124;
    /**
     * 服务异常
     */
    public static final int ALARM_SETTING_ABNORMAL = 170125;
    /**
     * 告警远程通知信息不存在
     */
    public static final int ALARM_FORWARD_FAILED = 170126;
}
