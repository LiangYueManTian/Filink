...
public class AlarmSetControllerTest {
    ...
    public void updateAlarmColorAndSoundTest() {
        ...
        Assert.assertEquals(result.getCode(), (int) AlarmSetResultCode.PLAY_TIMES_WRONG);
        alarmLevel.setPlayCount(null);
        result = alarmSetController.updateAlarmLevel(alarmLevel);
        Assert.assertEquals(result.getCode(), (int) AlarmSetResultCode.ALARM_LEVEL_ID_NULL);
        alarmLevel.setId("1");
        result = alarmSetController.updateAlarmLevel(alarmLevel);
        Assert.assertEquals(result.getCode(), (int) AlarmSetResultCode.SUCCESS);
//        new Expectations() {
//            {
...
//        };
    ...
    public void updateAlarmDelayTest() {
        ...
        Assert.assertEquals(result.getCode(),
                (int) AlarmSetResultCode.INCORRECT_RANGE_VALUE);
        alarmDelay.setDelay(null);
        result = alarmSetController.updateAlarmDelay(alarmDelay);
        Assert.assertEquals(result.getCode(),
                (int) AlarmSetResultCode.SUCCESS);
    }
