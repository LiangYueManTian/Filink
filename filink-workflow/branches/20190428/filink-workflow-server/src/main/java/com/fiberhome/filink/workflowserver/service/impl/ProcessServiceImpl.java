...
public class ProcessServiceImpl implements ProcessService {
     ...
     * @return 流程任务实例
     */
    private Task getCompleteTaskInfo(CompleteTaskReq req) {
        Task task = null;
     ...
     * @param task 流程任务实例
     */
    private void completeTaskProcess(CompleteTaskReq req, Task task) {
    ...
    public String getRuntimeProcType(String instanceId) {
        ...
        //获取流程的类型
        String procType = task.getProcessDefinitionId().split(":")[0];
        //查询需要更改的状态值
