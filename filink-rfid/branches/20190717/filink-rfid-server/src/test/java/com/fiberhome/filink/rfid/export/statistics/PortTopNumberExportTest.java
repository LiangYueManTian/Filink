...
public class PortTopNumberExportTest {
    /**
     * 被测试类
     */
    @InjectMocks
    ...
    public void setUp() {
        ...
        ExportPortTopNumberReq exportPortTopNumberReq = new ExportPortTopNumberReq();
        objectList.add(JSON.toJSON(exportPortTopNumberReq));
    ...
    public void queryData() {
        ...
        List list = portTopNumberExport.queryData(condition);
    ...
    public void queryCount() {
        ...
        Integer integer = portTopNumberExport.queryCount(condition);
