...
public interface OpticCableInfoDao extends BaseMapper<OpticCableInfo> {
     ...
     * @return int
     */
    int updateOpticCableIsDeletedById(@Param("opticCableId") String opticCableId, @Param("isDeleted") String isDeleted, @Param("updateUser") String updateUser,@Param("updateTime") Long updateTime);
