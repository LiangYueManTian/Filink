...
public class TemplateServiceImpl implements TemplateService {
    ...
    public Result createTemplate(TemplateReqDto templateVO) {
        ...
        if (templateVO.getTemplateType() == null || templateVO.getCol() == 0 || templateVO.getRow() == 0 ||
            ...
            return ResultI18Utils.convertWarnResult(RfIdResultCodeConstant.CREATE_TEMPLATE_PARAM_ERROR,
        ...
        if (templateDao.isExitsTemplateName(templateVO.getName().trim(), templateVO.getTemplateType()) > 0) {
            return ResultI18Utils.convertWarnResult(RfIdResultCodeConstant.TEMPLATE_NAME_IS_EXITS,
    ...
    public Result queryAllTemplate(TemplateReqDto templateVO) {
        if (templateVO == null || templateVO.getTemplateType() == null) {
            return ResultI18Utils.convertWarnResult(RfIdResultCodeConstant.QUERY_TEMPLATE_PARAM_ERROR,
    ...
    public Result queryRealPosition(RealReqDto realReqDto) {
        ...
        if (realReqDto == null || realReqDto.getDeviceId() == null) {
            return ResultI18Utils.convertWarnResult(RfIdResultCodeConstant.QUERY_REALPOSITION_PARAM_ERROR,
        ...
        if (boxRealPosition != null && boxRealPosition.size() != 0) {
            ...
            if (frameRealPosition != null && frameRealPosition.size() != 0) {
                List<String> frameIds = frameRealPosition.stream().map(RealPositionRspDto::getId).collect(Collectors.toList());
    ...
    public Result queryRealPositionByFrameId(String frameId, boolean isFlag) {
        if (null == frameId) {
            ...
            return ResultI18Utils.convertWarnResult(RfIdResultCodeConstant.QUERY_REALPOSITION_FRAMEID_ERROR,
    ...
    public Result queryFormationByDeviceId(String deviceId) {
        if (null == deviceId) {
            ...
            return ResultI18Utils.convertWarnResult(RfIdResultCodeConstant.QUERY_REALPOSITION_DEVICE_ID_ERROR,
        ...
        if (boxRealPosition == null || boxRealPosition.size() == 0) {
            return ResultI18Utils.convertWarnResult(RfIdResultCodeConstant.DEVICE_IS_NOT_CONFIGURE,
    ...
    public Result saveDeviceAndTempRelation(TemplateReqDto reqDto) {
        ...
        if (reqDto == null || reqDto.getBoxCodeRule() == null || reqDto.getBoxTrend() == null) {
            return ResultI18Utils.convertWarnResult(RfIdResultCodeConstant.SAVE_TEMPLATE_RELATION_ERROR,
    ...
    public Result queryPortInfoByPortId(String portId) {
        if (StringUtils.isEmpty(portId)) {
            return ResultI18Utils.convertWarnResult(RfIdResultCodeConstant.PORT_ID_IS_NULL, RfIdI18nConstant.PORT_ID_IS_NULL);
        }
        ...
        if (list != null && list.size() != 0) {
            list.parallelStream().forEach(obj -> {
                ...
                if (info.getLabelType() != null) {
                    jumpFiberInfoResp.setOppositePortMarkType(info.getLabelState().toString());
                }
    ...
    public Result queryTemplateTop(String deviceId) {
        if (deviceId == null) {
            return ResultI18Utils.convertWarnResult(RfIdResultCodeConstant.PARAMS_ERROR, RfIdI18nConstant.PARAMS_ERROR);
        }
        //查询框的信息 这里拼颗树给前端
    ...
    public Boolean getRfIdDataAuthInfo(String deviceId) {
        if (StringUtils.isEmpty(deviceId)) {
            throw new BizException(RfIdResultCodeConstant.PARAMS_ERROR, RfIdI18nConstant.PARAMS_ERROR);
        }
        DeviceInfoDto device = deviceFeign.getDeviceById(deviceId);
        //当前用户可以看到的设施类型
        ...
        //子集智能标签code
        String code = DeviceAuthEnum.getCodeByParent(device.getDeviceType());
    ...
    public void updatePortBindingState(String portId, Integer state, Integer busType, Integer portState) {
        if (StringUtils.isEmpty(portId)) {
            throw new BizException(RfIdResultCodeConstant.UPDATE_PORT_BINDING_PORT_IS_NULL,
                    RfIdI18nConstant.UPDATE_PORT_BINDING_PORT_IS_NULL);
        }
        if (state == null) {
            throw new BizException(RfIdResultCodeConstant.UPDATE_PORT_BINDING_STATE_IS_NULL,
                    RfIdI18nConstant.UPDATE_PORT_BINDING_STATE_IS_NULL);
        }
        if (busType == null) {
            throw new BizException(RfIdResultCodeConstant.UPDATE_PORT_BINDING_BUS_TYPE_IS_NULL,
    ...
    public Result updateTemplate(TemplateReqDto templateReqDtoList) {
        if (templateReqDtoList == null) {
            return ResultI18Utils.convertWarnResult(RfIdResultCodeConstant.UPDATE_TEMPLATE_PARAM_IS_NULL,
    ...
    public Result deleteTemplate(TemplateReqDto templateReqDto) {
        if (templateReqDto == null) {
            return ResultI18Utils.convertWarnResult(RfIdResultCodeConstant.DELETE_TEMPLATE_PARAM_IS_NULL,
        ...
        switch (templateType) {
            ...
            case 1:
                ...
                if (templateRspDtos != null && templateRspDtos.size() != 0) {
                    ...
                    if (templateIds != null && templateIds.size() != 0) {
                        return ResultI18Utils.convertWarnResult(RfIdResultCodeConstant.TEMPLATE_IS_NOT_DELETE,
            ...
            default:
                ...
                throw new BizException(RfIdResultCodeConstant.DELETE_TEMPLATE_PARAM_IS_NULL,
                        RfIdI18nConstant.DELETE_TEMPLATE_PARAM_IS_NULL);
        }
    ...
    private void deleteTemplateById(List<String> boxTemplateId, String templateId) {
        ...
        if (b) {
            throw new BizException(RfIdResultCodeConstant.TEMPLATE_IS_NOT_DELETE,
                    RfIdI18nConstant.TEMPLATE_IS_NOT_DELETE);
        } else {
            templateDao.deleteTemplateById(templateId);
        }
    ...
    private String convertBindState(Integer busType, String oldBindState, Integer state) {
        if (StringUtils.isEmpty(oldBindState)) {
            throw new BizException(RfIdResultCodeConstant.QUERY_BINDING_INFO_IS_NULL,
        ...
        if (BusTypeEnum.BUS_TYPE_FORMATION.ordinal() == busType) {
            ...
            throw new BizException(RfIdResultCodeConstant.UPDATE_PORT_BINDING_BUS_TYPE_NOT_FIND,
