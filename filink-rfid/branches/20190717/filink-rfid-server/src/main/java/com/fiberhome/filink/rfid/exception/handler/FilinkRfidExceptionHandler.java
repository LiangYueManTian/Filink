...
public class FilinkRfidExceptionHandler extends GlobalExceptionHandler {
    ...
    public Result handlerCommitProcInspectionException(FilinkObtainUserInfoException ex) {
        ...
        ex.printStackTrace();
        return ResultUtils.warn(RfIdResultCodeConstant.USER_SERVER_ERROR, I18nUtils.getSystemString(RfIdI18nConstant.USER_SERVER_ERROR));
    }
    ...
    public Result handlerPortInfoException(FilinkPortInfoException ex) {
        log.info(ex.getMessage());
        ex.printStackTrace();
        return ResultUtils.warn(RfIdResultCodeConstant.PORT_INFO_NOT_EXIST, I18nUtils.getSystemString(RfIdI18nConstant.PORT_INFO_NOT_EXIST));
    }
