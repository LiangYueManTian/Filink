...
public class OpticCableSectionInfoServiceImpl extends ServiceImpl<OpticCableSectionInfoDao, OpticCableSectionInfo> implements OpticCableSectionInfoService {
    ...
    public Result deleteOpticCableSectionByOpticCableSectionId(String opticCableSectionId) {
        ...
        if (ObjectUtils.isEmpty(opticCableSectionInfo)){
            return ResultUtils.warn(RfIdResultCodeConstant.OPTIC_CABLE_SECTION_NOT_EXIST, I18nUtils.getSystemString(RfIdI18nConstant.OPTIC_CABLE_SECTION_NOT_EXIST));
        }
        ...
        if (!ObjectUtils.isEmpty(coreCoreInfoRespList) || !ObjectUtils.isEmpty(portCableCoreInfoList)) {
            return ResultUtils.warn(RfIdResultCodeConstant.OPTIC_CABLE_SECTION_HAVE_SERVER, I18nUtils.getSystemString(RfIdI18nConstant.OPTIC_CABLE_SECTION_HAVE_SERVER));
        }
        ...
        opticCableSectionInfoReq.setUpdateTime(FiLinkTimeUtils.getUtcZeroTimeStamp());
        ...
        return ResultUtils.success(RfIdResultCodeConstant.SUCCESS, I18nUtils.getSystemString(RfIdI18nConstant.DELETE_OPTIC_CABLE_SECTION_SUCCESS));
    }
    ...
    public Result uploadOpticCableSectionInfoForApp(OperatorOpticCableSectionInfoReqForApp operatorOpticCableSectionInfoReqForApp) {
        ...
        if (AppConstant.OPERATOR_TYPE_SAVE.equals(operatorOpticCableSectionInfoReqForApp.getUploadType())) {
            ...
            if (Objects.isNull(coreNum)) {
                return ResultUtils.warn(RfIdResultCodeConstant.OPTIC_CABLE_SECTION_PARAM_ERROR,
            ...
            if (coreNum < Integer.valueOf(operatorOpticCableSectionInfoReqForApp.getCoreNum())) {
                return ResultUtils.warn(RfIdResultCodeConstant.OPTIC_CABLE_SECTION_CORE_OVERRUN,
            ...
            if (this.checkOpticCableSectionNameForApp(operatorOpticCableSectionInfoReqForApp)){
                return ResultUtils.warn(RfIdResultCodeConstant.OPTIC_CABLE_SECTION_NAME_SAME, I18nUtils.getSystemString(RfIdI18nConstant.OPTIC_CABLE_SECTION_NAME_SAME));
            }
        }
        int total = 0;
        //新增
        if (AppConstant.OPERATOR_TYPE_SAVE.equals(operatorOpticCableSectionInfoReqForApp.getUploadType())) {
            ...
            operatorOpticCableSectionInfoReqForApp.setCreateTime(FiLinkTimeUtils.getUtcZeroTimeStamp());
        ...
        if (AppConstant.OPERATOR_TYPE_UPDATE.equals(operatorOpticCableSectionInfoReqForApp.getUploadType())) {
            ...
            operatorOpticCableSectionInfoReqForApp.setUpdateTime(FiLinkTimeUtils.getUtcZeroTimeStamp());
        ...
        if (total < 1) {
            return ResultUtils.warn(RfIdResultCodeConstant.SAVE_OPTIC_CABLE_SECTION_FAIL,
    ...
    public Boolean checkOpticCableSectionNameForApp(OperatorOpticCableSectionInfoReqForApp operatorOpticCableSectionInfoReqForApp) {
        ...
        //光缆段名称重复校验
        OpticCableSectionInfo opticCableSectionInfo = opticCableSectionInfoDao.queryOpticCableSectionByName(opticCableSectionName,operatorOpticCableSectionInfoReqForApp.getBelongOpticCableId());
        if (!ObjectUtils.isEmpty(opticCableSectionInfo) && !opticCableSectionInfo.getOpticCableSectionId().equals(operatorOpticCableSectionInfoReqForApp.getOpticCableSectionId())) {
            return true;
        }
        return false;
    }
