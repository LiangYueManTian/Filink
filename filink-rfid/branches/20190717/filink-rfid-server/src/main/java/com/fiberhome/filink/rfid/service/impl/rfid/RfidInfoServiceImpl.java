...
public class RfidInfoServiceImpl extends ServiceImpl<RfidInfoDao, RfidInfo> implements RfidInfoService {
    ...
    public Result addRfidInfo(List<InsertRfidInfoReq> insertRfidInfoReqList) {
        ...
        for (InsertRfidInfoReq insertRfidInfoReq : insertRfidInfoReqList){
            ...
            insertRfidInfoReq.setCreateTime(FiLinkTimeUtils.getUtcZeroTimeStamp());
        ...
        return ResultUtils.success(RfIdResultCodeConstant.SUCCESS, I18nUtils.getSystemString(RfIdI18nConstant.SAVE_RFID_SUCCESS));
    }
    ...
    public Result deleteRfidInfo(Set<String> rfidCodeList) {
        ...
        for (String rfidCode : rfidCodeList){
            rfidInfoDao.deleteRfidInfo(rfidCode,RequestInfoUtils.getUserId(), FiLinkTimeUtils.getUtcZeroTimeStamp());
        }
        log.info("删除智能标签信息成功");
        //保存操作日志
        this.saveDeleteOperatorLog(rfidCodeList);
        log.info("删除智能标签操作日志成功");
        return ResultUtils.success(RfIdResultCodeConstant.SUCCESS, I18nUtils.getSystemString(RfIdI18nConstant.DELETE_RFID_SUCCESS));
    }
    ...
    public int deleteRfidInfoByDeviceId(String deviceId) {
        ...
        deleteRfidInfoReq.setUpdateTime(FiLinkTimeUtils.getUtcZeroTimeStamp());
