...
public class UpdateOpticCableSectionStatus {
     ...
     * @return void
     */
    public void updateOpticCableSectionStateByPortCableCore(Set<String> portCableSectionIdList){
        //已使用光缆段id
        Set<String> usePortCableSectionIdList = new HashSet<>();
        //获取所有已使用光缆段id
        for (String portCableSectionId : portCableSectionIdList){
     ...
     * @return void
     */
    public void updateOpticCableSectionStateByCoreCore(Set<String> portCableSectionIdList){
        //已使用光缆段id
        Set<String> usePortCableSectionIdList = new HashSet<>();
        //获取所有已使用光缆段id
        for (String portCableSectionId : portCableSectionIdList){
