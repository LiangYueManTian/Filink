...
public class AppConstant {
     ...
     * 光缆段ID
     */
    public static final String OPTICAL_CABLE_SECTION_ID = "optic_cable_section_id";
    /**
     * 光缆段名称
     */
    public static final String OPTICAL_CABLE_SECTION__NAME = "optic_cable_section_name";
    /**
     * 光缆段智能标签ID
     */
    public static final String OPTICAL_CABLE_SECTION_RFID_ID = "optic_status_id";
    /**
     * 光缆段标签CODE
     */
    public static final String OPTICAL_CABLE_SECTION__RFID_NAME = "rfid_code";
    /**
     * 操作符(新增)
     */
