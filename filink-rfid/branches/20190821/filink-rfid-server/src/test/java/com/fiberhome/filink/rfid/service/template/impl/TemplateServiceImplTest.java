...
public class TemplateServiceImplTest {
    ...
    private List<RealPositionRspDto> bs = Lists.newArrayList();
    /**
     * 初始化数据 frameReal
     */
    private List<RealRspDto> frameRealPosition = Lists.newArrayList();
    private List<RealPositionRspDto> fs = Lists.newArrayList();
    /**
     * 初始化数据 discReal
     */
    private List<RealRspDto> discRealPosition = Lists.newArrayList();
    private List<RealPositionRspDto> ds = Lists.newArrayList();
    /**
     * 初始化数据 portReal
     */
    private List<RealRspDto> portRealPosition = Lists.newArrayList();
    private List<RealPositionRspDto> ps = Lists.newArrayList();
    /**
     * 箱的坐标
     */
     ...
     * 箱的坐标
     */
    private RealPositionRspDto bos = new RealPositionRspDto();
    /**
     * 框的坐标
     */
    private RealPositionRspDto frams = new RealPositionRspDto();
    /**
     * 盘的坐标
     */
    private RealPositionRspDto diss = new RealPositionRspDto();
    /**
     * 端口的坐标
     */
    private RealPositionRspDto pos = new RealPositionRspDto();
    ...
    public void setUp() throws Exception {
        ...
        frams.setId("frameId");
        frams.setParentId("boxId");
        frams.setWidth(100.00);
        frams.setHeight(200.00);
        frams.setAbscissa(12.00);
        frams.setOrdinate(13.00);
        frams.setState(1);
        fs.add(frams);
        ...
        diss.setState(1);
        diss.setParentId("frameId");
        diss.setId("discId");
        diss.setPutState(1);
        diss.setWidth(100.00);
        diss.setHeight(200.00);
        diss.setAbscissa(12.00);
        diss.setOrdinate(13.00);
        ds.add(diss);
        ...
        pos.setId("portId");
        pos.setParentId("discId");
        pos.setWidth(100.00);
        pos.setHeight(200.00);
        pos.setAbscissa(12.00);
        pos.setOrdinate(13.00);
        ps.add(pos);
    }
    ...
    public void createTemplate() throws Exception {
        ...
        Assert.assertTrue(RfIdResultCode.CREATE_TEMPLATE_PARAM_ERROR.equals(result.getCode()));
        new Expectations() {
            {
    ...
    public void queryAllTemplate001() throws Exception {
        ...
        Assert.assertTrue(RfIdResultCode.QUERY_TEMPLATE_PARAM_ERROR.equals(result.getCode()));
        ...
        Assert.assertTrue(RfIdResultCode.QUERY_TEMPLATE_PARAM_ERROR.equals(result1.getCode()));
        // type=0 查询箱模板
        new Expectations() {
            {
    ...
    public void queryRealPosition() throws Exception {
        ...
        Assert.assertTrue(RfIdResultCode.QUERY_REALPOSITION_PARAM_ERROR.equals(result.getCode()));
    ...
    public void queryRealPosition001() throws Exception {
        ...
        new Expectations() {
            {
                templateDao.queryBoxReal((RealReqDto) any);
                result = bs;

                templateDao.queryFrameRealP((List<String>) any);
                result = fs;

                templateDao.queryDiscRealP((List<String>) any);
                result = ds;

                templateDao.queryPortRealP((List<String>) any);
                result = ps;
            }
        };
        RealReqDto realReqDto = new RealReqDto();
    ...
    public void queryRealPositionByFrameId() throws Exception {
        ...
        Assert.assertTrue(RfIdResultCode.QUERY_REALPOSITION_FRAMEID_ERROR.equals(result.getCode()));
    ...
    public void queryFormationByDeviceId() throws Exception {
        ...
        Assert.assertTrue(RfIdResultCode.QUERY_REALPOSITION_DEVICE_ID_ERROR.equals(result.getCode()));
        ...
        Assert.assertTrue(RfIdResultCode.DEVICE_IS_NOT_CONFIGURE.equals(result1.getCode()));
    ...
    public void saveDeviceAndTempRelation() throws Exception {
        ...
        Assert.assertTrue(RfIdResultCode.SAVE_TEMPLATE_RELATION_ERROR.equals(result.getCode()));

        TemplateReqDto reqDto = new TemplateReqDto();
        reqDto.setBoxCodeRule(1);
        reqDto.setBoxTrend(1);
        Result result1 = templateService.saveDeviceAndTempRelation(reqDto);
        Assert.assertTrue(RfIdResultCode.SAVE_TEMPLATE_RELATION_ERROR.equals(result1.getCode()));
        ...
        Assert.assertTrue(RfIdResultCode.SAVE_TEMPLATE_RELATION_ERROR.equals(result2.getCode()));

        reqDto.setDeviceId("deviceId");
        reqDto.setDeviceType("060");
        Result result3 = templateService.saveDeviceAndTempRelation(reqDto);
        Assert.assertTrue(RfIdResultCode.SAVE_TEMPLATE_RELATION_ERROR.equals(result3.getCode()));

        reqDto.setDiscTrend(1);
        reqDto.setDiscCodeRule(1);
        Result result4 = templateService.saveDeviceAndTempRelation(reqDto);
        Assert.assertTrue(RfIdResultCode.SUCCESS.equals(result4.getCode()));
    }
    ...
    public void queryPortInfoByPortId() throws Exception {
        ...
        Assert.assertTrue(RfIdResultCode.PORT_ID_IS_NULL.equals(result.getCode()));
...
//                result = portInfoBean;
    ...
    public void queryTemplateTop() throws Exception {
        ...
        Assert.assertTrue(RfIdResultCode.PARAMS_ERROR.equals(result.getCode()));
    ...
    public void updatePortState() throws Exception {
        ...
        Assert.assertTrue(RfIdResultCode.PARAMS_ERROR.equals(result1.getCode()));
    ...
    public void getRfIdDataAuthInfo() throws Exception {
        ...
        new Expectations() {
            {
                deviceFeign.queryDeviceTypeById(anyString);
                result = "060";
    ...
    public void updatePortBindingState() throws Exception {
        try {
            ...
            Assert.assertEquals(RfIdResultCode.UPDATE_PORT_BINDING_PORT_IS_NULL, e.getCode());
        }
        try {
            templateService.updatePortBindingState("portId", null, 1, 1);
        } catch (BizException e) {
            Assert.assertEquals(RfIdResultCode.UPDATE_PORT_BINDING_STATE_IS_NULL, e.getCode());
        }
        try {
            templateService.updatePortBindingState("portId", 1, null, 1);
        } catch (BizException e) {
            Assert.assertEquals(RfIdResultCode.UPDATE_PORT_BINDING_BUS_TYPE_IS_NULL, e.getCode());
        }
    ...
    public void updateTemplate() throws Exception {
        ...
        Assert.assertTrue(RfIdResultCode.UPDATE_TEMPLATE_PARAM_IS_NULL.equals(result.getCode()));
    ...
    public void deleteTemplate001() throws Exception {
        ...
        Assert.assertTrue(RfIdResultCode.DELETE_TEMPLATE_PARAM_IS_NULL.equals(result.getCode()));

        TemplateReqDto reqDto = new TemplateReqDto();
        reqDto.setTemplateType(0);
        Result result1 = templateService.deleteTemplate(reqDto);
        Assert.assertTrue(RfIdResultCode.DELETE_TEMPLATE_PARAM_IS_NULL.equals(result1.getCode()));
        ...
        try {
            ...
            Assert.assertEquals(RfIdResultCode.TEMPLATE_IS_NOT_DELETE, e.getCode());
        }
    ...
    public void deleteTemplate002() throws Exception {
        ...
        Assert.assertTrue(RfIdResultCode.TEMPLATE_IS_NOT_DELETE.equals(result.getCode()));
