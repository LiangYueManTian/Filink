...
/**
 * OpticalFiberStatisticsExportTest
 *
...
public class OpticalFiberStatisticsExportTest {
    /**
     * 被测试类
     */
    @InjectMocks
    ...
    public void queryData() {
        ...
        List list = opticalFiberStatisticsExport.queryData(condition);
    ...
    public void queryCount() {
        ...
        Integer integer = opticalFiberStatisticsExport.queryCount(condition);
