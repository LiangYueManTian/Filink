...
//        when(jumpFiberInfoService.assemblyJumpFiberInfoResp(jumpFiberInfoRespList1,queryJumpFiberInfoReq1)).thenReturn(jumpFiberInfoRespList3);
    ...
    @Test
    public void exportJumpFiberList002() {
...
//        };
        ...
        Assert.assertFalse(result.getCode() == RfIdResultCode.EXPORT_DATA_TOO_LARGE);
    }

    @Test
    public void exportJumpFiberList003() {
//        new Expectations(MessageFormat.class) {
//            {
//                MessageFormat.format(anyString, any);
//                result = "demo";
...
//        };
        ...
        Result result = jumpFiberInfoService.exportJumpFiberList(exportDto);
        Assert.assertTrue(result.getCode() != RfIdResultCode.EXCEED_THE_MAXIMUM_NUMBER_OF_TASKS);
    }

    @Test
    public void exportJumpFiberList004() {
//        new Expectations(MessageFormat.class) {
//            {
//                MessageFormat.format(anyString, any);
//                result = "demo";
...
//        };
        ...
        Result result = jumpFiberInfoService.exportJumpFiberList(exportDto);
        Assert.assertTrue(result.getCode() != RfIdResultCode.FAILED_TO_CREATE_EXPORT_TASK);
    }

    @Test
    public void exportJumpFiberList001() {
//        new Expectations(MessageFormat.class) {
//            {
//                MessageFormat.format(anyString, any);
//                result = "demo";
...
//        };
        ...
        when(jumpFiberExport.insertTask(exportDto, "filink-rfid-server", null))
                ...
                .thenReturn(new ExportRequestInfo());
        Result result = jumpFiberInfoService.exportJumpFiberList(exportDto);
        Assert.assertFalse(result.getCode() == RfIdResultCode.EXPORT_NO_DATA);
    ...
    public void queryJumpFiberInfoByPortInfoForApp() {
        ...
        jumpFiberInfoRespForApp.setRfidCode("dede");
        jumpFiberInfoRespForApp.setOppositeRfidCode("dede");
        ...
        List<RfidInfoResp> infoResps = Lists.newArrayList();
        RfidInfoResp infoResp = new RfidInfoResp();
        infoResp.setRfidCode("dede");
        infoResp.setRfidStatus("0");
        infoResps.add(infoResp);
        when(rfidInfoDao.queryRfidInfoByRfidCodes(any())).thenReturn(infoResps);
