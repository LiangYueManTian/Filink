...
public class MobileAsyncTest {
    ...
    private RealRspDto port1 = new RealRspDto();
    ...
    public void setUp() throws Exception {
        ...
        port1.setId("portId1");
        port1.setParentId("discId");
        port1.setWidth(100.00);
        port1.setHeight(200.00);
        port1.setAbscissa(12.00);
        port1.setOrdinate(13.00);
        port1.setColNo(1);
        port1.setRowNo(1);
        port1.setRealNo(1);
    ...
    public void calcOldPosition001() throws Exception {
        ...
        try {
            ...
            Assert.assertTrue(e.getCode().equals(RfIdResultCode.NOT_QUERY_DATA));
        }
        ...
        ReflectionTestUtils.setField(mobileAsync, "mysqlBatchNum", 1);
        new Expectations() {
            {
                templateDao.queryFrameReal((List<String>) any);
                result = frameRealPosition;
    ...
    public void calcNewPosition() throws Exception {
        try {
            ...
            Assert.assertTrue(e.getCode().equals(RfIdResultCode.ADD_DEVICE_ENTITY_PARAM_BOX_DATA_NULL));
        }

        try {
            mobileAsync.calcNewPosition(null, boxRealPosition, null, null);
        } catch (BizException e) {
            Assert.assertTrue(e.getCode().equals(RfIdResultCode.ADD_DEVICE_ENTITY_PARAM_NEW_FRAME_DATA_NULL));
        }

        try {
            mobileAsync.calcNewPosition(null, boxRealPosition, frameRealPosition, null);
        } catch (BizException e) {
            Assert.assertTrue(e.getCode().equals(RfIdResultCode.ADD_DEVICE_ENTITY_PARAM_NEW_DISC_DATA_NULL));
        }
        DeviceUploadDto uploadDto = new DeviceUploadDto();
        uploadDto.setBoxTemplateId("boxTemplateId");
        uploadDto.setDeviceId("deviceId");
