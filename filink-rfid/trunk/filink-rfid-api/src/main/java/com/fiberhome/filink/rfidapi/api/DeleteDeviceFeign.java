...
public interface DeleteDeviceFeign {
     ...
     *
     * @param deviceIds
     * @return Map<String,Boolean> key 为4种类型 成端、熔纤、跳纤、光缆段
     */
    @PostMapping("/deleteDevice/checkDevices")
    Map<String, Boolean> checkDevices(@RequestBody List<String> deviceIds);
