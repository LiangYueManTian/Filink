...
import com.fiberhome.filink.lockserver.stream.ControlChannel;
...
@EnableBinding({UdpChannel.class, OneNetChannel.class, OceanConnectChannel.class, ControlChannel.class})
@EnableHystrix
