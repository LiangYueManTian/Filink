...
public class AreaInfoServiceImplTest {
    ...
    public void addArea() {
        ...
        Assert.assertTrue(result.getCode() == AreaResultCode.NAME_IS_EXIST);
        new Expectations() {
            {
                areaInfoDao.selectAreaInfoByName((AreaInfo) any);
                result = null;
    ...
    public void queryAreaListByItem() {
        ...
        Assert.assertTrue(result.getCode() == AreaResultCode.PARAM_NULL);
    ...
    public void deleteAreaByIds() {
        ...
        Assert.assertTrue(result.getCode() == AreaResultCode.HAVE_CHILD);
        new Expectations() {
            {
                areaInfoDao.selectAreaIdByParentId(anyString);
                result = strings;
        ...
        Assert.assertTrue(result2.getCode() == AreaResultCode.HAVE_DEVICE);
        list.clear();
        try {
    ...
    public void exportAreaTest() {
        ...
        Assert.assertTrue(result2.getCode() == AreaResultCode.EXPORT_NO_DATA);
        new Expectations() {
            {
                I18nUtils.getSystemString(AreaI18nConstant.EXPORT_DATA_TOO_LARGE);
        ...
        Assert.assertTrue(result1.getCode() == AreaResultCode.EXPORT_DATA_TOO_LARGE);
        new Expectations() {
            {
                areaExport.insertTask((ExportDto) any, anyString, anyString);
        ...
        Assert.assertTrue(result3.getCode() == AreaResultCode.EXCEED_THE_MAXIMUM_NUMBER_OF_TASKS);
        new Expectations() {
            {
                areaExport.insertTask((ExportDto) any, anyString, anyString);
        ...
        Assert.assertTrue(result4.getCode() == AreaResultCode.FAILED_TO_CREATE_EXPORT_TASK);
    }
    ...
    public void selectChildAreaInfoTest() {
        ...
        new Expectations() {
            {
                userFeign.queryUserByIdList((List) any);
                result = new FilinkAttentionRequestParamException();
            }
        };
        try {
            areaInfoService.selectChildAreaInfo(areaInfoTreeList);
        ...
        new Expectations() {
            {
                userFeign.queryUserByIdList((List) any);
                result = new DeviceExceptionHandler();
            }
        };
        try {
            areaInfoService.selectChildAreaInfo(areaInfoTreeList);
        ...
        new Expectations() {
            {
                userFeign.queryUserByIdList((List) any);
                result = new FilinkDeviceNameSameException();
            }
        };
        try {
            areaInfoService.selectChildAreaInfo(areaInfoTreeList);
        ...
        new Expectations() {
            {
                userFeign.queryUserByIdList((List) any);
                result = new FiLinkDeviceLogException("test");
            }
        };
        try {
            areaInfoService.selectChildAreaInfo(areaInfoTreeList);
     ...
     */
    @Test
    public void queryAreaInfoByIds() {
        List<String> areaIds = new ArrayList<>();
        areaInfoService.queryAreaInfoByIds(areaIds);
        areaIds.add("001");
        AreaInfo areaInfo = new AreaInfo();
        areaInfo.setAreaId("001");
        Set<String> set = new HashSet<>();
        set.add("001");
        areaInfo.setAccountabilityUnit(set);
        List<AreaInfo> areaInfoList = new ArrayList<>();
        areaInfoList.add(areaInfo);
        new Expectations() {
            {
                areaInfoDao.selectAreaInfoByIds((List) any);
                result = areaInfoList;
            }
        };
        areaInfoService.queryAreaInfoByIds(areaIds);
...
//    /**
//     * queryAreaListAllForPermission Test
//     */
//    @Test
//    public void queryAreaListAllForPermission(){
//        List<String> areaIds = new ArrayList<>();
//        areaInfoService.queryAreaListAllForPermission(areaIds);
//    }
}
