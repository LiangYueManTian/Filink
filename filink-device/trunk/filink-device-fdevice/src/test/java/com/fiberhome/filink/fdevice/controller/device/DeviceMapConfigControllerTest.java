...
public class DeviceMapConfigControllerTest {
    ...
    @Test
    public void insertConfigBatchUsers() {
        Assert.assertFalse(deviceMapConfigController.insertConfigBatchUsers(null));
        List<String> deviceIds = new ArrayList<>();
        deviceIds.add("xx");
        new Expectations() {
            {
                deviceMapConfigService.insertConfigBatchUsers(deviceIds);
                result = true;
            }
        };
        Assert.assertTrue(deviceMapConfigController.insertConfigBatchUsers(deviceIds));
