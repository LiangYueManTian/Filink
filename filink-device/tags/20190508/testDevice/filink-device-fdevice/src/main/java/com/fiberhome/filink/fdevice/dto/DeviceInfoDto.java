...
//    private TemplateReqDto templateReqDto;
    ...
    public String getTranslationDeviceStatus() {
        return I18nUtils.getString(ExportApiUtils.getExportLocales(),DeviceStatus.getDesc(deviceStatus));
    }

    @JsonIgnore
    public String getTranslationDeployStatus() {
        return I18nUtils.getString(ExportApiUtils.getExportLocales(), DeployStatus.getMsg(deployStatus));
    }
}
