...
public interface DeviceLogService {
     ...
     * @return
     */
    Result deleteDeviceLogByDeviceIds(List<String> deviceIdList);
     ...
     * 同步开锁次数统计
     */
    void synchronizeUnlockingStatistics();
     ...
     * @return
     */
    Integer queryUnlockingCountByDeviceId(String deviceId, Long startTime, Long endTime);
