...
public class DeviceStatusCountExportTest {
    @InjectMocks
    ...
    public void queryData() {
        ...
        DeviceStatusDto deviceInfoForTopNum = new DeviceStatusDto();
        ...
        List list = deviceStatusCountExport.queryData(condition);
    ...
    public void queryCount() {
        ...
        Integer integer = deviceStatusCountExport.queryCount(new QueryCondition());
