...
public interface AreaInfoService extends IService<AreaInfo> {
    ...
    /**
     * 根据区域权限获取有区域权限的第一个区域ID
     *
     * @param areaIds 区域权限
     * @return 区域信息
     */
    String queryAreaListAllForPermission(List<String> areaIds);
     ...
     * @return 缓存中所有的区域信息
     */
    List<AreaInfoForeignDto> getAreaInfoFromRedis();
     ...
     * @return
     */
    List<AreaInfo> queryAreaInfoByIds(List<String> areaIdList);
     ...
     * @return 部门信息
     */
    List<Department> queryDeptCommonByAreaId(List<String> areaIdList);
}
