...
public class AreaInfoController {
    ...
    public Result queryAreaNameIsExist(@RequestBody AreaInfo areaInfo) {
        if (StringUtils.isEmpty(areaInfo.getAreaName())) {
            return ResultUtils.warn(AreaResultCodeConstant.AREA_NAME_NULL, I18nUtils.getSystemString(AreaI18nConstant.AREA_NAME_NULL));
        }
        if (!areaInfo.checkAreaName()) {
            return ResultUtils.warn(AreaResultCodeConstant.AREA_NAME_FORMAT_IS_INCORRECT, I18nUtils.getSystemString(AreaI18nConstant.AREA_NAME_FORMAT_IS_INCORRECT));
        }
    ...
    public Result queryAreaDetailsCanChange(@PathVariable String areaId) {
        ...
        if (flag) {
            ...
            return ResultUtils.warn(AreaResultCodeConstant.FALSE);
        }
    }
    ...
    public Result addArea(@RequestBody AreaInfo areaInfo) {
        ...
        if (StringUtils.isEmpty(lockIdentifier)) {
            return ResultUtils.warn(AreaResultCodeConstant.BUSY_SERVER, I18nUtils.getSystemString(AreaI18nConstant.BUSY_SERVER));
        }
    ...
    public Result setAreaDevice(@RequestBody Map<String, List<String>> map) {
        ...
        return ResultUtils.warn(AreaResultCodeConstant.RELATED_FACILITIES_FAIL, I18nUtils.getSystemString(AreaI18nConstant.RELATED_FACILITIES_FAIL));
    }
