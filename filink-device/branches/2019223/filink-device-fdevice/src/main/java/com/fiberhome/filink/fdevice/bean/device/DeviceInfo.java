...
public class DeviceInfo extends Model<DeviceInfo> {
     ...
     * 责任单位
     */
    @TableField("accountability_unit")
    ...
    public boolean checkDeviceName() {
        String devicenameRegex = "^(?!_)[\\w\\s_\\u4e00-\\u9fa5]{1,128}$";
        return this.deviceName.matches(devicenameRegex);
    }
    ...
    public boolean checkParameterFormat() {
        ...
        return checkStringRegex(this.remarks, remarkRegex) && checkStringRegex(this.address, addressRegex);
    }
