...
public class DeviceInfoServiceImplTest {
    ...
    public void checkDeviceNameTest() {
        DeviceInfo deviceInfo = new DeviceInfo();
        deviceInfo.setDeviceName("一号设施");
        deviceInfo.setDeviceId("1");
        when(deviceInfoDao.selectByName("一号设施")).thenReturn(deviceInfo);
        boolean result1 = deviceInfoService.checkDeviceName("", "一号设施");
        boolean result2 = deviceInfoService.checkDeviceName("1", "一号设施");
        boolean result3 = deviceInfoService.checkDeviceName("2", "一号设施");
    ...
    public void setAreaDevice() {
        ...
        list.add("s1");
        //返回List有值
        when(alarmCurrentFeign.queryAlarmSource(list)).thenReturn(list);
        DeviceInfo deviceInfo = new DeviceInfo();
        ...
        //List没有值
        when(alarmCurrentFeign.queryAlarmSource(list)).thenReturn(new ArrayList<>());
