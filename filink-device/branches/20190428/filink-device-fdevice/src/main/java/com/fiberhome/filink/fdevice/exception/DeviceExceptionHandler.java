...
public class DeviceExceptionHandler extends GlobalExceptionHandler {
    ...
    public Result handlerAreaDirtyDataException(FilinkAreaDirtyDataException ex) {
        ...
        if (StringUtils.isEmpty(msg)) {
            return ResultUtils.warn(AreaResultCodeConstant.DIRTY_DATA, I18nUtils.getString(AreaI18nConstant.DIRTY_DATA));
        }
    ...
    public Result handlerAreaDateBaseException(FilinkAreaDateBaseException ex) {
        ...
        String msg = ex.getMessage();
        if (StringUtils.isEmpty(msg)) {
            return ResultUtils.warn(AreaResultCodeConstant.DATE_BASE_ERROR, I18nUtils.getString(AreaI18nConstant.DATA_BASE_ERROR));
        }
    ...
    public Result handlerAreaNoDataPermissionsException(FilinkAreaNoDataPermissionsException ex) {
        ...
        ex.printStackTrace();
        return ResultUtils.warn(AreaResultCodeConstant.NO_DATA_PERMISSIONS, I18nUtils.getString(AreaI18nConstant.NO_DATA_PERMISSIONS));
    }
    ...
    public Result handlerAreaDateFormatException(FilinkAreaDateFormatException ex) {
        log.info(ex.getMessage());
        ex.printStackTrace();
        return ResultUtils.warn(AreaResultCodeConstant.PARAMETER_FORMAT_IS_INCORRECT, I18nUtils.getString(AreaI18nConstant.PARAMETER_FORMAT_IS_INCORRECT));
    }
    ...
    public Result handlerFilinkRequestParamException(FilinkAttentionRequestParamException ex) {
        log.info(ex.getMessage());
        ex.printStackTrace();
        return ResultUtils.warn(DeviceCollectingResultCode.ATTENTION_REQUEST_PARAMS_ERROR, I18nUtils.getString(DeviceCollectingI18n.PARAMS_ERROR));
    }
    ...
    public Result handlerFilinkSystemErrorException(FilinkAttentionDataException ex) {
        log.info(ex.getMessage());
        ex.printStackTrace();
        return ResultUtils.warn(DeviceCollectingResultCode.ATTENTION_DATA_ERROR, I18nUtils.getString(DeviceCollectingI18n.DATA_ERROR));
    }
    ...
    public Result handlerFilinkSystemErrorException(FilinkAttentionRepeatException ex) {
        log.info(ex.getMessage());
        ex.printStackTrace();
        return ResultUtils.warn(DeviceCollectingResultCode.ATTENTION_REPEAT_ERROR, I18nUtils.getString(DeviceCollectingI18n.REPEAT_ERROR));
    }
}
