...
public class DeviceInfoController {
    ...
    public Result checkDeviceName(@RequestBody DeviceInfo deviceInfo) {
        if (ObjectUtils.isEmpty(deviceInfo)) {
            return ResultUtils.success(DeviceResultCode.DEVICE_PARAM_ERROR, I18nUtils.getString(DeviceI18n.DEVICE_NAME_NULL), false);
        }
    ...
    public Result queryDeviceDtoByAreaIdForPageSelection(@PathVariable String areaId) {
        ...
        return ResultUtils.success(DeviceResultCode.SUCCESS, I18nUtils.getString(DeviceI18n.QUERY_DEVICE_SUCCESS), deviceInfoDtoList);
    }
     ...
     * @return 设施基本信息
     */
    @GetMapping("/queryDeviceAreaListBase")
    public Result queryDeviceAreaListBase() {
        return deviceInfoService.queryDeviceAreaListBase();
    }
     ...
     * @return 设施基本信息
     */
    @GetMapping("/queryDeviceAreaListSimple")
    public Result queryDeviceAreaListSimple() {
        return deviceInfoService.queryDeviceAreaListSimple();
    }
    ...
    public Result exportDeviceList(@RequestBody ExportDto exportDto) {
        if (!exportDto.checkParam()) {
            return ResultUtils.warn(DeviceResultCode.EXPORT_PARAM_NULL, I18nUtils.getString(DeviceI18n.EXPORT_PARAM_NULL));
        }
    ...
    public Result queryDeviceTypesByAreaIds(@RequestBody List<String> areaIds) {
        ...
        return ResultUtils.success(DeviceResultCode.SUCCESS, I18nUtils.getString(DeviceI18n.QUERY_DEVICE_SUCCESS), deviceTypeList);
    }
