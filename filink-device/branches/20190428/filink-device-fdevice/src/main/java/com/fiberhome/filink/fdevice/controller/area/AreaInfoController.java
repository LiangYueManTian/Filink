...
public class AreaInfoController {
    ...
    public Result queryAreaNameIsExist(@RequestBody AreaInfo areaInfo) {
        if (StringUtils.isEmpty(areaInfo.getAreaName())) {
            return ResultUtils.warn(AreaResultCodeConstant.AREA_NAME_NULL, I18nUtils.getString(AreaI18nConstant.AREA_NAME_NULL));
        }
        if (!areaInfo.checkAreaName()) {
            return ResultUtils.warn(AreaResultCodeConstant.AREA_NAME_FORMAT_IS_INCORRECT, I18nUtils.getString(AreaI18nConstant.AREA_NAME_FORMAT_IS_INCORRECT));
        }
    ...
    public Result setAreaDevice(@RequestBody Map<String, List<String>> map) {
        ...
        if (flag) {
            return ResultUtils.success(ResultCode.SUCCESS, I18nUtils.getString(AreaI18nConstant.ASSOCIATED_FACILITIES_SUCCESSFUL));
        }
        return ResultUtils.warn(AreaResultCodeConstant.RELATED_FACILITIES_FAIL, I18nUtils.getString(AreaI18nConstant.RELATED_FACILITIES_FAIL));
    }
