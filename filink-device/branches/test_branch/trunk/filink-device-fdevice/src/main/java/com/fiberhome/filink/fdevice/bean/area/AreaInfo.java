...
public class AreaInfo extends Model<AreaInfo> {
    ...
    public String getTranslationLevel() {
        ...
        switch (level) {
            case 1:
                return I18nUtils.getString(exportLocales,AreaI18nConstant.LEVEL_ONE);
            case 2:
                return I18nUtils.getString(exportLocales,AreaI18nConstant.LEVEL_TWO);
            case 3:
                return I18nUtils.getString(exportLocales,AreaI18nConstant.LEVEL_THREE);
            case 4:
                return I18nUtils.getString(exportLocales,AreaI18nConstant.LEVEL_FOUR);
            case 5:
                return I18nUtils.getString(exportLocales,AreaI18nConstant.LEVEL_FIVE);
            default:
                return null;
        }
    }
