...
public class PartsResultCode extends ResultCode {
	 ...
	 * 没有数据导出
	 */
	public static final Integer EXPORT_NO_DATA = 130308;

	/**
	 * 当前用户超过最大任务数量
	 */
	public static final Integer EXCEED_THE_MAXIMUM_NUMBER_OF_TASKS = 130309;

	/**
	 * 配件名称不合法
	 */
    public static final Integer PARTS_NAME_ERROR = 130310;

	/**
	 * 配件未授权
	 */
	public static final Integer PARTS_NOT_AUTHORIZED = 130311;

	/**
	 * 用户信息查询失败
	 */
	public static final Integer USER_INFO_ERROR = 130312;
}
