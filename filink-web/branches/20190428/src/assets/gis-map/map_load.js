...
var MAP_TYPE = window.MAP_TYPE = 'baidu';
...
(function () {
  ...
  if (MAP_TYPE === 'baidu') {  // 百度地图
    ...
    document.write('<script type="text/javascript" src="https://api.map.baidu.com/library/TextIconOverlay/1.2/src/TextIconOverlay_min.js"></script>');
