import {WORK_ORDER_SERVER} from '../api-common.config';
...
export const WORK_ORDER_URL = {
  ...
  // 销账工单列表今日新增统计
  GET_INCREASE_CLEAR_BARRIER_WORK_ORDER_STATISTICS: `${CLEAR_BARRIER}/queryCountClearFailureProcByToday`,
  // 销账工单未完工列表状态总数统计
  GET_UNFINISHED_CLEAR_BARRIER_WORK_ORDER_STATISTICS: `${CLEAR_BARRIER}/queryCountListProcUnfinishedProcStatus`,
  // 故障原因统计的销障工单信息
  GET_CLEAR_BARRIER_WORK_ORDER_STATISTICS_BY_ERROR_REASON: `${CLEAR_BARRIER}/queryListClearFailureGroupByErrorReason`,
  // 处理方案统计的销障工单信息
  GET_CLEAR_BARRIER_WORK_ORDER_STATISTICS_BY_PROCESSING_SCHEME: `${CLEAR_BARRIER}/queryListClearFailureGroupByProcessingScheme`,
  // 设施类型统计的销障工单信息
  GET_CLEAR_BARRIER_WORK_ORDER_STATISTICS_BY_DEVICE_TYPE: `${CLEAR_BARRIER}/queryListClearFailureGroupByDeviceType`,
  // 工单状态统计的销障工单信息
  GET_CLEAR_BARRIER_WORK_ORDER_STATISTICS_BY_STATUS: `${CLEAR_BARRIER}/queryListClearFailureByStatus`,
  // 销账工单历史列表总数统计
