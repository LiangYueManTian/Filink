...
export class FacilityAgreementComponent extends BasicConfig implements OnInit {
  title = this.language.agreement.addFacilityProtocol;
  // 新增弹出框显示隐藏
  isVisible = false;
  // 协议名称
  agreementName: '';
  ...
  queryConditions: QueryCondition = new QueryCondition();
      ...
      topButtons: [
        {
          ...
          handle: () => {
            ...
            // this.validateForm = this.fb.group({
            //   agreementName: [this.agreementName, [Validators.maxLength(32)], [AsyncRuleUtil.nameReg().asyncRule]],
            // });
          }
        }, {
