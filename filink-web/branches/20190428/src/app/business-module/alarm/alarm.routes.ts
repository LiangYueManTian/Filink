...
export const ROUTER_CONFIG: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: {
          breadcrumb: [
            {label: 'alarm', url: 'current-alarm'},
            {label: 'currentAlarmTemplate'}]
        }
      },
      {
        path: 'history-alarm',
      ...
      {
        path: 'alarm-filter',
        component: AlarmFilterComponent,
        data: {
          breadcrumb: [
            {label: 'alarm'},
            {label: 'alarmset'},
      ...
      {
        path: 'add-alarm-filter/:type',
        component: AddAlarmFilterComponent,
        data: {
          breadcrumb: [{label: 'alarm', url: 'alarm-filter'}, {label: 'alarmFilter', url: 'alarm-filter'}, {label: 'alarmFilter'}]
        }
      },
      {
        path: 'modify-alarm-filter/:type',
        component: ModifyAlarmFilterComponent,
        data: {
          breadcrumb: [{label: 'alarm', url: 'alarm-filter'}, {label: 'alarmFilter', url: 'alarm-filter'}, {label: 'alarmFilter'}]
        }
      },
