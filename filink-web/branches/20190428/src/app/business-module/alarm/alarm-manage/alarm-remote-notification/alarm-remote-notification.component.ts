  ...
  private initTableConfig() {
    this.tableConfig = {
      ...
      columnConfig: [
        ...
        {
          // 设施类型
          title: this.language.alarmSourceType, key: 'alarmForwardRuleDeviceTypeList', width: 280, isShowSort: true,
          type: 'render',
          configurable: true,
        ...
        {
          // 推送方式
          title: this.language.pushType, key: 'pushType', width: 200, isShowSort: true,
          searchable: true,
          type: 'render',
          configurable: true,
          ...
          searchConfig: {
            // 1 是邮件 2 是短信
            type: 'select', selectType: 'multiple', selectInfo: [
              {label: this.language.mail, value: '1'},
              {label: this.language.note, value: '2'}
            ]
          },
          handleFilter: ($event) => {
