...
import { AreaLevel, getAreaLevel } from '../../../facility/facility.config';
      ...
      rightTopButtons: [
        ...
        },
        {
          ...
          handle: (data) => {
            ...
            if (ids.length > 0) {
              // 跳转到操作日志
              this.$router.navigate(['/business/system/log'], { queryParams: { id: ids } }).then();
            } else {
  ...
  private initTreeSelectorConfig() {
    ...
    this.treeSelectorConfig = {
      ...
      selectedColumn: [
        ...
        {
          title: this.areaLanguage.parentDept, key: 'parmentDeparmentName', width: 100,
        }
      ]
    };
  }
