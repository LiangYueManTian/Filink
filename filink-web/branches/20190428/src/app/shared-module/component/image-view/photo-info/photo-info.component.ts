      ...
      if (result.code === 0) {
          ...
          switch (result.data.status) {
            case resourceStatus.PIC_STATUS_CLEAR_UNFINISHED:
              url = '/business/work-order/clear-barrier/unfinished';
              break;
            case resourceStatus.PIC_STATUS_CLEAR_HIS:
              url = '/business/work-order/clear-barrier/history';
              break;
            case resourceStatus.PIC_STATUS_INSPECTION_UNFINISHED:
              url = '/business/work-order/inspection/unfinished';
              break;
            case resourceStatus.PIC_STATUS_INSPECTION_HIS:
              url = '/business/work-order/inspection/finished';
              break;
