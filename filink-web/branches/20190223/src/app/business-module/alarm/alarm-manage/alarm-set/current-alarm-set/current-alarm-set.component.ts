...
export class CurrentAlarmSetComponent implements OnInit {
  ...
  refreshData() {
    ...
    this.$alarmService.queryAlarmCurrentSetList(this.queryCondition).subscribe((res: Result) => {
    ...
    this.tableConfig = {
      ...
      columnConfig: [
        { type: 'select', fixedStyle: { fixedLeft: true, style: { left: '0px' } }, width: 62 },
        {
          ...
          fixedStyle: { fixedLeft: true, style: { left: '103px' } }
        },
        {
          title: this.language.alarmName, key: 'alarmName', width: 100, isShowSort: true,
          configurable: true,
          searchable: true,
          searchConfig: { type: 'input' },
          fixedStyle: { fixedLeft: true, style: { left: '206px' } }
        },
        {
          title: this.language.alarmDefaultLevel, key: 'alarmDefaultLevel', width: 100, isShowSort: true,
          configurable: true,
          searchable: true,
          searchConfig: { type: 'input' },
          type: 'render',
        ...
        {
          title: this.language.alarmLevel, key: 'alarmLevel', width: 100, isShowSort: true,
          configurable: true,
          searchable: true,
          type: 'render',
        ...
        {
          title: this.language.alarmAutomaticConfirmation, key: 'alarmAutomaticConfirmation', width: 100, isShowSort: true,
          configurable: true,
          searchable: true,
          type: 'render',
