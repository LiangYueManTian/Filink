...
import {InspectionTableComponent} from '../../../../index/log-order-panel/inspection-table/inspection-table.component';
...
export class FacilityWorkOrderComponent implements OnInit, AfterViewInit {
  ...
  hasControl: boolean;
  // 巡检工单列表实例
  @ViewChild('inspectionTable') inspectionTable: InspectionTableComponent;
  // 公共语言包
