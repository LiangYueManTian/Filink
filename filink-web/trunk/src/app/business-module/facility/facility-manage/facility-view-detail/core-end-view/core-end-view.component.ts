...
import {Qunee} from '../../../../../../assets/js/qunee/qunee-module.js';
...
export class CoreEndViewComponent implements OnInit {
  @Input() viewCoreEndIsVisible = false; // 纤芯成端
  @Output() viewCloseCoreEnd = new EventEmitter();
   ...
   */
  checkData() {
    if (this.selectBox !== undefined && this.selectBox !== '' && this._opticCableSectionId !== undefined && this._opticCableSectionId !== '' &&
      this.boxId !== undefined && this.boxId !== '' && this.plateAorB !== undefined && this.plateAorB !== '' && this.plateHave === numberType.one) {
      return true;
    } else {
      return false;
    }
