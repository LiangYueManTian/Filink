...
import {Colour, WorkOrderConfig} from '../../../work-order.config';
  ...
  initTableConfig() {
    this.tableConfig = {
      ...
      columnConfig: [
        ...
        {
          // 备注
          title: this.workOrderLanguage.remark, key: 'remark', width: 150,
          configurable: true,
          isShowSort: true,
          searchable: false,
          searchConfig: {type: 'input'}
        ...
        {
          // 转派原因
          title: this.workOrderLanguage.turnReason, key: 'turnReason', width: 150,
          configurable: true,
          isShowSort: true,
          searchable: false,
          searchConfig: {type: 'input'}
        ...
        {// 退单原因
          title: this.commonLanguage.retreatSingleReason, key: 'concatSingleBackReason', width: 200,
          configurable: true,
          isShowSort: true,
          searchable: true,
