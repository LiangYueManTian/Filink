...
export class HistoryAlarmTableComponent extends IndexTable implements OnInit, OnChanges {
  ...
  goToWorkOrderById(id) {
    this.$router.navigate([`business/work-order/clear-barrier/unfinished-list`], {queryParams: {alarmId: id}}).then();
  }
  ...
  initTableConfig() {
    this.tableConfig = {
      ...
      columnConfig: [
        ...
        {
          title: this.indexLanguage.nearTime, key: 'alarmBeginTime', width: 90, pipe: 'date',
          searchable: false,
        },
        {
