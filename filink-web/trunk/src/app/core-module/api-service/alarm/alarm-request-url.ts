...
import {ALARM_SET_SERVER, DEVICEINFO, USER_SERVER, DEVICE_SERVER, COMMON_PREFIX, WORK_ORDER_SERVER} from '../api-common.config';
...
export const DEVICE_DETAIL_ALARM_STATISTICS = {
  // 设施统计当前告警级别信息
  currentLevel: `${ALARM_STATISTICS}/queryAlarmCurrentSourceLevel`,
  // 设施统计历史告警级别信息
  historyLevel: `${ALARM_STATISTICS}/queryAlarmHistorySourceLevel`,
  // 设施统计当前告警名称信息
  currentSourceName: `${ALARM_STATISTICS}/queryAlarmCurrentSourceName`,
  // 设施统计历史告警名称信息
  historySourceName: `${ALARM_STATISTICS}/queryAlarmHistorySourceName`,
  //  设施统计告警增量
  alarmSourceIncremental: `${ALARM_STATISTICS}/queryAlarmSourceIncremental`
};
// 查询责任单位下是否有告警转工单规则
