...
public class ProfileUtil {
    ...
    private void resolveService(Element element, Map<String, ServiceBean> serviceMap,
        ...
        if (element == null) {
            log.error("the {} of the appId : {} is null", nodeName, appId);
            return;
        }
        //service
        Element serviceElement = element.element(SERVICE_NODE);
        if (serviceElement == null) {
            log.error("the {} service node of the appId : {} is null", nodeName, appId);
            return;
        }
     ...
     * @return profile对象
     */
    public Platform initProfileConfig() {
