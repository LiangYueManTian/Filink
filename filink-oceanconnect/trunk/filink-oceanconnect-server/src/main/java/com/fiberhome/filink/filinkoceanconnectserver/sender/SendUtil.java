...
public class SendUtil {
    ...
    public void sendData(FiLinkReqOceanConnectParams oceanConnectParams, String data) {
        ...
        String equipmentId = oceanConnectParams.getEquipmentId();
        if (StringUtils.isEmpty(oceanConnectId)) {
            log.error("[sendMsg] : oceanConnect id of the control {} is null", equipmentId);
            return;
        }
        //获取token信息
        ...
        log.info("[sendMsg] : the control {} response content: {}", equipmentId, responseBody);
    }
