...
import com.fiberhome.filink.filinkoceanconnectserver.business.DeviceThread;
import com.fiberhome.filink.filinkoceanconnectserver.business.FiLinkNewMsgBusinessHandler;
...
public class OceanConnectController {
     ...
     * @return
     */
    @GetMapping("/getDevice/{deviceId}/{count}")
    public Map getDevice(@PathVariable String deviceId, @PathVariable Integer count) throws Exception{
        deviceThread.reset();
        for (int i = 0; i < count; i++) {
            deviceThread.queryDevice(deviceId);
        }
        Thread.sleep(5000);
    ...
    public static void main(String[] args)  throws Exception{
        BufferedReader bufferedReader = new BufferedReader(new FileReader(new File("C:\\Users\\congcong\\Desktop\\aaa.txt")));
        BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(new File("C:\\Users\\congcong\\Desktop\\bbb.txt")));
        String data = "FFEF0101F8EB4C0400000000002F42474D50000100002208000100000000001D000000005D2D3AA7000000010000390801000200000000000000000000";
        String s;
        while ((s = bufferedReader.readLine()) != null){
            String replace = data.replace("0101F8EB4C0400000000", s);
