...
public interface ProcClearFailureService extends IService<ProcClearFailure> {
     ...
     */
    List<ProcBaseRespForApp> queryLoginUserClearFailureListForApp(ProcBaseReq procBaseReq);
     ...
     * @return 工单关联部门信息
     */
    List<ProcClearFailure> queryClearRelateDeptByProcIds(@Param("list") List<String> list);
     ...
     * @return 工单关联部门信息
     */
    List<ProcClearFailure> queryClearProcListByDeptIds(@Param("deptIds") List<String> deptIds);
     ...
     * @return 工单关联信息
     */
    List<ProcClearFailure> queryClearProcListByDeptIdsAndAreaId(@Param("deptIds") List<String> deptIds,@Param("areaId") String areaId);
