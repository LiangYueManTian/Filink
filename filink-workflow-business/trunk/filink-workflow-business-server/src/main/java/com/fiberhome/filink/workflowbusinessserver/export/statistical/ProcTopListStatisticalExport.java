...
import com.fiberhome.filink.workflowbusinessserver.bean.statistical.export.ProcTopListStatisticalExportBean;
 ...
 */
@Component
public class ProcTopListStatisticalExport extends AbstractExport {
    ...
    protected List queryData(QueryCondition queryCondition) {
        ...
        List<ProcTopListStatisticalExportBean> exportList = new ArrayList<>();
        for (Object object : objectList) {
            ProcTopListStatisticalExportBean exportBean = JSONObject.toJavaObject(JSONObject.parseObject(JSONObject.toJSONString(object)), ProcTopListStatisticalExportBean.class);
