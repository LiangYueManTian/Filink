...
public class ProcClearFailureServiceImpl extends ServiceImpl<ProcClearFailureDao, ProcClearFailure> implements ProcClearFailureService {
    ...
    public Result addClearFailureProc(InsertClearFailureReq insertClearFailureReq) throws Exception {
        ...
        if (!ObjectUtils.isEmpty(processInfo.getProcBase())){
            ...
            return ResultUtils.warn(ResultCode.FAIL, I18nUtils.getSystemString(ProcBaseI18n.PROC_PARAM_ERROR));
        }
    }
    ...
    public Result queryClearFailureProcTopFive(String deviceId) {
        ...
        if (null == objects){
            return ResultUtils.warn(ResultCode.FAIL,I18nUtils.getSystemString(ProcBaseI18n.DEVICE_PIC_SERVER_ERROR));
        }
    ...
    public Result receiptClearFailureProcForApp(ReceiptClearFailureReq receiptClearFailureReq) {
        ...
        if (1 != procClearFailureDao.receiptProcClearFailureById(procBase)){
            return ResultUtils.warn(ResultCode.FAIL, I18nUtils.getSystemString(ProcBaseI18n.PROC_RECEIPT_FAIL));
        }
        ...
        //销障
        return ResultUtils.success(ResultCode.SUCCESS, I18nUtils.getSystemString(ProcBaseI18n.PROC_RECEIPT_SUCCESS));
    }
     ...
     */
    @Override
    public List<ProcClearFailure> queryClearProcListByDeptIdsAndAreaId(List<String> deptIds, String areaId) {
        return procClearFailureDao.queryClearProcListByDeptIdsAndAreaId(deptIds, areaId);
    }
    ...
    public Result queryListClearFailureByStatus(){
        ...
        return ResultUtils.success(ResultCode.SUCCESS, I18nUtils.getSystemString(ProcBaseI18n.QUERY_PROC_STATUS_COUNT_SUCCESS),statusMap);
    }
    ...
    public Result checkProcParamsForClearFailure(ProcessInfo processInfo){
        ...
        if (procBaseService.queryExistsProcForAlarm(processInfo.getProcBase(),processInfo.getOperaType())){
            return ResultUtils.warn(WorkflowBusinessResultCode.IS_EXISTS_PROC_FOR_ALARM, I18nUtils.getSystemString(ProcBaseI18n.IS_EXISTS_PROC_FOR_ALARM));
        }
