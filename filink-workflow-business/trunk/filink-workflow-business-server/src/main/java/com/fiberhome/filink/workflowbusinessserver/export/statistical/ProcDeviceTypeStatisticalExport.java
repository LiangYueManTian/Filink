...
import com.fiberhome.filink.workflowbusinessserver.bean.statistical.export.ProcDeviceTypeStatisticalExportBean;
 ...
 */
@Component
public class ProcDeviceTypeStatisticalExport extends AbstractExport {
    ...
    protected List queryData(QueryCondition queryCondition) {
        ...
        List<ProcDeviceTypeStatisticalExportBean> exportList = new ArrayList<>();
        for (Object object : objectList) {
            ProcDeviceTypeStatisticalExportBean exportBean = JSONObject.toJavaObject(JSONObject.parseObject(JSONObject.toJSONString(object)), ProcDeviceTypeStatisticalExportBean.class);
