...
public class QueryListInspectionTaskByPageVo {
    ...
    public String getTranslationInspectionTaskStatus() {
        ...
        if (InspectionTaskConstants.INSPECTION_TASK_WAIT.equals(this.inspectionTaskStatus)) {
            //巡检状态未巡检
            inspectionTaskName = I18nUtils.getString(ExportApiUtils.getExportLocales(), InspectionTaskI18n.INSPECTION_STATUS_WAIT);
        } else if (InspectionTaskConstants.INSPECTION_TASK_DOING.equals(this.inspectionTaskStatus)) {
            //巡检状态巡检中
            inspectionTaskName = I18nUtils.getString(ExportApiUtils.getExportLocales(), InspectionTaskI18n.INSPECTION_STATUS_DOING);
        } else if (InspectionTaskConstants.INSPECTION_TASK_COMPLETED.equals(this.inspectionTaskStatus)) {
            //巡检状态已完成
            inspectionTaskName = I18nUtils.getString(ExportApiUtils.getExportLocales(), InspectionTaskI18n.INSPECTION_STATUS_COMPLETED);
        }
    ...
    public String getTranslationIsOpen() {
        ...
        if (InspectionTaskConstants.IS_OPEN.equals(this.isOpen)) {
            //巡检任务启用
            translationIsOpen = I18nUtils.getString(ExportApiUtils.getExportLocales(), InspectionTaskI18n.IS_OPEN);
        } else if (InspectionTaskConstants.IS_CLOSE.equals(this.isOpen)) {
            //巡检任务禁用
            translationIsOpen = I18nUtils.getString(ExportApiUtils.getExportLocales(), InspectionTaskI18n.IS_CLOSE);
        }
    ...
    public String getTranslationInspectionTaskType() {
        ...
        if (InspectionTaskConstants.TASK_TYPE_ROUTINE_INSPECTION.equals(this.inspectionTaskType)) {
            //例行巡检
            translationInspectionTaskType = I18nUtils.getString(ExportApiUtils.getExportLocales(), InspectionTaskI18n.TASK_TYPE_ROUTINE_INSPECTION);
        }
