...
import com.fiberhome.filink.workflowbusinessserver.resp.app.procinspection.ProcInspectionRelatedDeviceForApp;
...
public class InspectionTaskServiceTest {
     ...
     */
    @Test
    public void callInspectionDownLoadDetail() {
        InspectionDownLoadDetail inspectionDownLoadDetail = new InspectionDownLoadDetail();
        inspectionDownLoadDetail.getAssign();
        inspectionDownLoadDetail.getEndTime();
        inspectionDownLoadDetail.getProcId();
        inspectionDownLoadDetail.getProcRelatedDeviceRespList();
        inspectionDownLoadDetail.getProcType();
        inspectionDownLoadDetail.getStartTime();
        inspectionDownLoadDetail.getTitle();
    }
     ...
     */
    @Test
    public void callProcInspectionRelatedDeviceForApp() {
        ProcInspectionRelatedDeviceForApp deviceForApp = new ProcInspectionRelatedDeviceForApp();
        deviceForApp.getAddress();
        deviceForApp.getDeviceAreaId();
        deviceForApp.getDeviceAreaName();
        deviceForApp.getDeviceId();
        deviceForApp.getDeviceName();
        deviceForApp.getPositionBase();
    }
     ...
     */
    @Test
    public void callInspectionTaskReq() {
        QueryListInspectionTaskByPageReq req = new QueryListInspectionTaskByPageReq();
        req.getInspectionTaskIds();
        req.getInspectionTaskName();
        req.getInspectionTaskStatus();
        req.getInspectionTaskStatusList();
        req.getInspectionTaskType();
        req.getInspectionTaskTypes();
        req.getTaskPeriod();
        req.getTaskPeriodOperate();
        req.getTaskPeriodOperateValue();
        req.getProcPlanDate();
        req.getProcPlanDateOperate();
        req.getProcPlanDateOperateValue();
        req.getTaskStartTime();
        req.getStartTimes();
        req.getTaskEndTime();
        req.getEndTimes();
        req.getInspectionAreaIds();
        req.getDeptIds();
        req.getInspectionDeviceCount();
        req.getInspectionDeviceCountOperate();
        req.getInspectionDeviceCountOperateValue();
        req.getPermissionDeviceTypes();
        req.getPermissionAreaIds();
        req.getPermissionDeptIds();
        req.getIsOpen();
        req.getIsOpens();
