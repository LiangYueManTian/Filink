...
public class ProcStatisticalController {
    ...
    public void insertTest() {
        procStatisticalService.insertTest();
    }

    /**
     * 新增测试工单数据
     */
    @PostMapping("/insertTestCustomData")
    public void insertTestCustomData() {
        procStatisticalService.insertTestCustomData();
    }

    /**
     * 新增巡检任务信息
     */
    @PostMapping("/addProcInspectionInfo")
    public void addProcInspectionInfo() {
        procStatisticalService.addProcInspectionInfo();
    }
