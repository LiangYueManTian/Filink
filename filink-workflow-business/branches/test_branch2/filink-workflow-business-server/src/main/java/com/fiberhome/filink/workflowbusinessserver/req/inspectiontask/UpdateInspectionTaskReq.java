 ...
 */
@Data
public class UpdateInspectionTaskReq {
     ...
     * @return Result 返回值
     */
    public static boolean validateUpdateInspectionTaskReq(UpdateInspectionTaskReq req) {
        //巡检任务编号
        String inspectionTaskId = req.getInspectionTaskId();
        if (!InspectionTaskValidate.checkInspectionTaskId(inspectionTaskId)) {
            return false;
        }
        ...
        //校验关联信息
        if (!UpdateInspectionTaskReq.checkInspectionTaskRelated(req)) {
            return false;
        }
     ...
     * @return 校验结果
     */
    public static boolean checkInspectionTaskRelated(UpdateInspectionTaskReq req) {
        //巡检任务关联单位
