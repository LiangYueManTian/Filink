...
public class ProcClearFailureServiceImplTest {
    ...
    public void exportClearFailureProcUnfinished() {
        ...
        Assert.assertTrue(result.getCode() == ProcBaseResultCode.EXPORT_DATA_TOO_LARGE);

        result = procClearFailureService.exportClearFailureProcUnfinished(exportDto);
        Assert.assertTrue(result.getCode() == ProcBaseResultCode.EXCEED_THE_MAXIMUM_NUMBER_OF_TASKS);

        result = procClearFailureService.exportClearFailureProcUnfinished(exportDto);
        Assert.assertTrue(result.getCode() == ProcBaseResultCode.FAILED_TO_CREATE_EXPORT_TASK);
