...
public class AlarmProcessServiceTest {
     ...
     */
    @Test
    public void callAlarmClass() {
        Alarm alarm = new Alarm();
        alarm.getAlarmNameId();
        alarm.getAlarmContent();
        alarm.getAlarmType();
        alarm.getAlarmSource();
        alarm.getAlarmSourceType();
        alarm.getAlarmSourceTypeId();
        alarm.getAreaId();
        alarm.getAreaName();
        alarm.getOrder();
        alarm.setOrder(true);
        alarm.getAddress();
        alarm.getAlarmFixedLevel();
        alarm.getAlarmObject();
        alarm.getResponsibleDepartment();
        alarm.getResponsibleDepartmentId();
        alarm.getPrompt();
        alarm.getAlarmNearTime();
        alarm.getAlarmSystemTime();
        alarm.getAlarmSystemNearTime();
        alarm.getAlarmContinouTime();
        alarm.setAlarmContinouTime(1);
        alarm.getAlarmHappenCount();
        alarm.getAlarmCleanStatus();
        alarm.getAlarmCleanType();
        alarm.getAlarmCleanPeopleId();
        alarm.getAlarmCleanPeopleNickname();
        alarm.getAlarmConfirmStatus();
        alarm.getAlarmConfirmTime();
        alarm.getAlarmConfirmPeopleId();
        alarm.getAlarmConfirmPeopleNickname();
        alarm.getExtraMsg();
        alarm.getAlarmProcessing();
        alarm.getRemark();
        alarm.getTrapOid();
        alarm.setPicture(true);
        alarm.getPicture();
        alarm.getControlId();
    }
