...
public class ProcBaseI18n {
    ...
    public static final String CHECK_SINGLE_BACK_STATUS_ERROR = "CHECK_SINGLE_BACK_STATUS_ERROR";
    ...
    public static final String REVOKE_STATUS_ERROR = "REVOKE_STATUS_ERROR";
    ...
    public static final String ASSIGN_STATUS_ERROR = "ASSIGN_STATUS_ERROR";
     ...
     * 无当前工单操作权限
     */
    public static final String PROC_IS_NOT_PERMISSION = "PROC_IS_NOT_PERMISSION";
