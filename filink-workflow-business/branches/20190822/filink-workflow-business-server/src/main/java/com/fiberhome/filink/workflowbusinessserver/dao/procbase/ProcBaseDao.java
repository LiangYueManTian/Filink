...
public interface ProcBaseDao extends BaseMapper<ProcBase> {
     ...
     * @return ProcBaseResp
     */
    ProcBaseResp queryProcessByProcId(@Param ("procId") String procId, @Param("nowDateTime") Long nowDateTime);
     ...
     * @return 返回修改信息的条数
     */
    int updateInspectionCreateAlarmInfo(@Param("procIds") List<String> procIds, @Param("updateTime")Date updateTime);
     ...
     * @return 返回修改信息的条数
     */
    int updateClearCreateAlarmInfo(@Param("procIds") List<String> procIds, @Param("updateTime")Date updateTime);
