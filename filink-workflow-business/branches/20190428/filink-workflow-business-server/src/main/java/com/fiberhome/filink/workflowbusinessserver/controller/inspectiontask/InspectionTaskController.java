...
public class InspectionTaskController {
     ...
     */
    private String checkInspectionTaskList(List<String> inspectionTaskIds, String operator) {
    ...
    public Result queryInspectionTaskIsExists(@RequestBody InspectionTask inspectionTask) {
        if (StringUtils.isEmpty(inspectionTask.getInspectionTaskName())) {
            return ResultUtils.warn(InspectionTaskResultCode.PARAM_ERROR, I18nUtils.getString(InspectionTaskI18n.PARAM_ERROR));
        }
        //新增及修改校验
        ...
        return ResultUtils.success(ResultCode.SUCCESS, I18nUtils.getString(InspectionTaskI18n.INSPECTION_NAME_IS_AVAILABLE));
    }
