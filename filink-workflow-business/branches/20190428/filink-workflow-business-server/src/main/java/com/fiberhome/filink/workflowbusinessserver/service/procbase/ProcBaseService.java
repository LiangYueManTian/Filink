...
public interface ProcBaseService extends IService<ProcBase> {
     ...
     * @return 修改的工单数据
     */
    ProcessInfo assignProcProcess(AssignProcReq req);
     ...
     * @param req 转办工单
     */
    void turnProcProcess(TurnProcReq req);
     ...
     */
    QueryCondition getPermissionsInfo(QueryCondition<ProcBaseReq> queryCondition);
     ...
     * @return queryCondition    查询对象
     */
    QueryCondition getPermissionsInfoForExport(QueryCondition<ProcBaseReq> queryCondition);
