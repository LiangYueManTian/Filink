...
public class ClearFailureProcUnfinishedExport extends AbstractExport {
    ...
    protected List queryData(QueryCondition queryCondition) {
        ...
        List<ProcBaseResp> procBaseRespList = procClearFailureDao.queryListProcClearUnfinishedProcByPage(queryCondition);
        // 构造页面需要数据
    ...
    protected Integer queryCount(QueryCondition queryCondition) {
        ...
        Integer count = procClearFailureDao.queryCountListProcClearUnfinishedProc(queryCondition);
        return count;
    }
