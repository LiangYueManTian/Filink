...
public class FilinkWorkflowBusinessExceptionHandler extends GlobalExceptionHandler {
    ...
    public Result handlerAddProcErrorException(AddProcErrorException ex) {
        log.error("新增工单异常", ex);
        return ResultUtils.warn(ProcBaseResultCode.PROC_ADD_ERROR, I18nUtils.getSystemString(ProcBaseI18n.ADD_PROC_FAIL));
    }
    ...
    public Result handlerUpdateProcErrorException(UpdateProcErrorException ex) {
        log.error("修改工单异常", ex);
        return ResultUtils.warn(ProcBaseResultCode.PROC_UPDATE_ERROR, I18nUtils.getSystemString(ProcBaseI18n.UPDATE_PROC_FAIL));
    }
    ...
    public Result handlerAssignProcErrorException(AssignProcErrorException ex) {
        log.error("工单指派异常", ex);
        return ResultUtils.warn(ProcBaseResultCode.PROC_ASSIGN_ERROR, I18nUtils.getSystemString(ProcBaseI18n.PROC_ASSIGN_FAIL));
    }
    ...
    public Result handlerDownloadProcErrorException(DownLoadProcErrorException ex) {
        log.error("工单下载异常", ex);
        return ResultUtils.warn(ProcBaseResultCode.PROC_DOWNLOAD_ERROR, I18nUtils.getSystemString(ProcBaseI18n.DOWNLOAD_PROC_FAIL));
    }
    ...
    public Result handlerRevokeProcErrorException(RevokeProcErrorException ex) {
        log.error("工单撤回异常", ex);
        return ResultUtils.warn(ProcBaseResultCode.PROC_REVOKE_ERROR, I18nUtils.getSystemString(ProcBaseI18n.REVOKE_FAIL));
    }
    ...
    public Result handlerSingleBackProcErrorException(SingleBackProcErrorException ex) {
        log.error("工单退单异常", ex);
        return ResultUtils.warn(ProcBaseResultCode.PROC_SINGLE_BACK_ERROR, I18nUtils.getSystemString(ProcBaseI18n.SINGLE_BACK_FAIL));
    }
    ...
    public Result handlerTurnProcErrorException(TurnProcErrorException ex) {
        log.error("工单转派异常", ex);
        return ResultUtils.warn(ProcBaseResultCode.PROC_TURN_ERROR, I18nUtils.getSystemString(ProcBaseI18n.PROC_TURN_FAIL));
    }
    ...
    public Result handlerCheckSingleBackProcErrorException(CheckSingleBackProcErrorException ex) {
        log.error("确认退单异常", ex);
        return ResultUtils.warn(ProcBaseResultCode.PROC_CHECK_SINGLE_BACK_ERROR, I18nUtils.getSystemString(ProcBaseI18n.CHECK_SINGLE_BACK_FAIL));
    }
    ...
    public Result handlerInspectionDeviceException(InspectionDeviceException ex) {
        log.error("巡检设施异常", ex);
        return ResultUtils.warn(ProcInspectionResultCode.INSPECTION_DEVICE_FAILED, I18nUtils.getSystemString(ProcInspectionI18n.INSPECTION_DEVICE_FAILED));
    }
    ...
    public Result handlerCommitProcInspectionException(CommitProcInspectionException ex) {
        log.error("提交巡检工单异常", ex);
        return ResultUtils.warn(ProcInspectionResultCode.COMMIT_INSPECTION_FAILED, I18nUtils.getSystemString(ProcInspectionI18n.COMMIT_INSPECTION_FAILED));
    }
    ...
    public Result handlerCommitProcInspectionException(FilinkObtainUserInfoException ex) {
        ...
        return ResultUtils.warn(ProcBaseResultCode.USER_SERVER_ERROR, I18nUtils.getSystemString(ProcBaseI18n.USER_SERVER_ERROR));
    }
    ...
    public Result handlerCommitProcInspectionException(FilinkObtainAlarmInfoException ex) {
        log.error("获取告警信息异常", ex);
        return ResultUtils.warn(ProcBaseResultCode.ALARM_SERVER_ERROR, I18nUtils.getSystemString(ProcBaseI18n.ALARM_SERVER_ERROR));
    }
    ...
    public Result handlerObtainDeviceInfoException(FilinkObtainDeviceInfoException ex) {
        log.error("获取设施信息异常", ex);
        return ResultUtils.warn(ProcBaseResultCode.DEVICE_SERVER_ERROR, I18nUtils.getSystemString(ProcBaseI18n.FAILED_TO_OBTAIN_DEVICE_INFORMATION));
    }
    ...
    public Result handlerDeleteProcErrorException(DeleteProcErrorException ex) {
        log.error("删除工单失败", ex);
        return ResultUtils.warn(ProcBaseResultCode.DELETE_PROC_FAIL, I18nUtils.getSystemString(ProcBaseI18n.DELETE_PROC_FAIL));
    }
