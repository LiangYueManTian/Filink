...
public class MenuControllerTest {
    ...
    public void addMenuTemplate() {
        ...
        menuTemplateAndMenuInfoTree.setTemplateName(lengthStr);
        try {
            menuController.addMenuTemplate(menuTemplateAndMenuInfoTree);
        } catch (Exception e) {
            Assert.assertTrue(e.getClass() == FilinkMenuDateFormatException.class);
        }
    }
