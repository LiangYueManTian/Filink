...
public class DeviceProtocolResultCode extends ResultCode {
    ...
    /**上传文件内容错误*/
    public static final Integer DEVICE_PROTOCOL_FILE_CONTENT_ERROR = 210302;
    /**设施协议名称已存在*/
    ...
    /**名称格式错误*/
    public static final Integer DEVICE_PROTOCOL_NAME_ERROR = 2103011;
    /**上传文件名称过长*/
    public static final Integer DEVICE_PROTOCOL_FILE_NAME_ERROR = 210312;
    /**上传文件尺寸过大*/
    public static final Integer DEVICE_PROTOCOL_FILE_SIZE_ERROR = 210313;
}
