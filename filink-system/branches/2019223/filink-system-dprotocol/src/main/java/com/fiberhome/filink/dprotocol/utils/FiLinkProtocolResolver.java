...
import com.fiberhome.filink.dprotocol.bean.xmlBean.data.*;
import com.fiberhome.filink.dprotocol.bean.xmlBean.format.DataFormat;
import com.fiberhome.filink.dprotocol.bean.xmlBean.format.DataFormatParam;
import com.fiberhome.filink.dprotocol.bean.xmlBean.header.ResponseHeader;
...
public class FiLinkProtocolResolver {
     ...
     * @return List
     */
    public FiLinkProtocolBean resolve(Document document) {
        try {
