...
public class SystemParameterServiceImpl implements SystemParameterService {
    ...
    public Integer queryHomeDeviceLimit() {
        ...
        return displaySettings.getHomeDeviceLimit();
    }
    ...
    public Result updateMessage(AliAccessKeyParam aliAccessKeyParam) {
        ...
        //记录日志
        addLog(aliAccessKeyParam.getParamId(), SystemParameterI18n.SYSTEM_PARAMETER_MESSAGE, SystemParameterConstants.MESSAGE_FUNCTION_CODE);
    ...
    public Result updateMail(AliAccessKeyParam aliAccessKeyParam) {
        ...
        //记录日志
        addLog(aliAccessKeyParam.getParamId(), SystemParameterI18n.SYSTEM_PARAMETER_MAIL, SystemParameterConstants.MAIL_FUNCTION_CODE);
        return ResultUtils.success(SystemParameterResultCode.SUCCESS,
    ...
    public Result updateMessageNotification(MessageNotificationParam messageNotificationParam) {
        ...
        //记录日志
        addLog(messageNotificationParam.getParamId(), SystemParameterI18n.SYSTEM_PARAMETER_MESSAGE_NOTIFICATION, SystemParameterConstants.MESSAGE_NOTIFICATION_FUNCTION_CODE);
        return ResultUtils.success(SystemParameterResultCode.SUCCESS,
    ...
    public Result updateMobilePush(AliAccessKeyParam aliAccessKeyParam) {
        ...
        //记录日志
        addLog(aliAccessKeyParam.getParamId(), SystemParameterI18n.SYSTEM_PARAMETER_MOBILE_PUSH, SystemParameterConstants.MOBILE_PUSH_FUNCTION_CODE);
        return ResultUtils.success(SystemParameterResultCode.SUCCESS,
    ...
    public Result updateDisplaySettings(DisplaySettingsParam displaySettingsParam, MultipartFile file) {
        ...
        //获取后台显示设置当前值
        DisplaySettings displaySettingsData = parseDisplaySettings(sysParam);
        //获取修改显示设置值
        DisplaySettings displaySettings  = displaySettingsParam.getDisplaySettings();
        //系统图标路径
        String logoUrl;
        String logoUrlDb = displaySettingsData.getSystemLogo();
        if  (file != null) {
            //校验系统图标大小和后缀名
            ...
            //上传文件
            logoUrl = uploadSystemLogo(file);
            displaySettings.setSystemLogo(logoUrl);
        } else if (SystemParameterConstants.DEFAULT_SYSTEM_LOGO.equals(displaySettings.getSystemLogo())) {
            logoUrl = null;
        } else {
            logoUrl = null;
            logoUrlDb = null;
        ...
        //转成JSON
        String presentValue = JSON.toJSONString(displaySettings);
        //封装数据
        ...
        //修改首页首次加载数量
        deviceFeign.updateHomeDeviceLimit(displaySettings.getHomeDeviceLimit());
        //修改系统语言缓存
        String language = displaySettings.getSystemLanguage();
        RedisUtils.set(ParamTypeRedisEnum.SYSTEM_LANGUAGE.getKey(), language);
        //发送kafka修改所有服务缓存
        languageUtil.sendChangeLanguage(language);
        //删除原图片
        deleteLogo(logoUrlDb);
        //记录日志
        addLog(displaySettingsParam.getParamId(), SystemParameterI18n.SYSTEM_PARAMETER_DISPLAY_SETTINGS, SystemParameterConstants.DISPLAY_FUNCTION_CODE);
        return ResultUtils.success(SystemParameterResultCode.SUCCESS,
    ...
    public Result updateFtpSettings(FtpSettingsParam ftpSettingsParam) {
        ...
        //记录日志
        addLog(ftpSettingsParam.getParamId(), SystemParameterI18n.SYSTEM_PARAMETER_FTP, SystemParameterConstants.FTP_FUNCTION_CODE);
        return ResultUtils.success(SystemParameterResultCode.SUCCESS,
    ...
    public Result sendMailTest(MailSendTest mailSendTest) {
        ...
        aliyunEmail.setFromAlias(languageUtil.getI18nString(SystemParameterI18n.FROM_ALIAS));
        aliyunEmail.setSubject(languageUtil.getI18nString(SystemParameterI18n.SUBJECT));
        aliyunEmail.setTagName(aliSendTest.getTagName());
        aliyunEmail.setHtmlBody(languageUtil.getI18nString(SystemParameterI18n.HTML_BODY));
        try {
    ...
    public Result ftpSettingsTest(FtpSettingsParam ftpSettingsParam) {
        ...
        try {
            ...
            if (!positiveCompletion) {
                return ResultUtils.success(SystemParameterResultCode.FTP_LOGIN_ERROR,
                        I18nUtils.getSystemString(SystemParameterI18n.FTP_LOGIN_ERROR));
            }

        } catch (Exception e) {
            log.info("app ftp ip or  port is error***");
            return ResultUtils.success(SystemParameterResultCode.APP_FTP_HOST_PORT_ERROR,
                    I18nUtils.getSystemString(SystemParameterI18n.APP_FTP_HOST_PORT_ERROR));
        }
        //WEB FTP校验
        try {
            ...
            return ResultUtils.success(SystemParameterResultCode.WEB_FTP_HOST_PORT_ERROR,
                    I18nUtils.getSystemString(SystemParameterI18n.WEB_FTP_HOST_PORT_ERROR));
        }
        return ResultUtils.success(SystemParameterResultCode.SUCCESS,
    ...
    private void addLog(String paramId, String systemParameterName, String functionCode) {
        ...
        //获得操作对象名称
        String name = languageUtil.getI18nString(systemParameterName);
        addLogBean.setOptObj(name);
