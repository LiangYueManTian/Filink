 ...
 * @since 2019-01-12
 */
public class MenuResultCodeConstant extends ResultCode {
    /**
     * 菜单名称为null
     */
     ...
     * 正在使用的菜单模板被修改 用于消息推送
     */
    public static final Integer USED_MENU_TEMPLATE_UPDATE = 2100211;
    /**
     * 服务器繁忙
     */
    public static final Integer BUSY_SERVER = 210212;
}
