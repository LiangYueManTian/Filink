...
public class SecurityStrategyServiceImpl implements SecurityStrategyService {
    ...
    public Result updatePasswordStrategy(PasswordParam passwordParam) {
        ...
        //记录日志
        addLog(sysParam.getParamId(), SecurityStrategyI18n.PASSWORD_SECURITY_STRATEGY, SecurityStrategyConstants.PASSWORD_FUNCTION_CODE);
        return ResultUtils.success(ResultCode.SUCCESS,
                I18nUtils.getSystemString(SecurityStrategyI18n.PASSWORD_STRATEGY_UPDATE_SUCCESS));
    }
    ...
    public Result updateAccountStrategy(AccountParam accountParam) {
        ...
        //记录日志
        addLog(sysParam.getParamId(), SecurityStrategyI18n.ACCOUNT_SECURITY_STRATEGY, SecurityStrategyConstants.ACCOUNT_FUNCTION_CODE);
        return ResultUtils.success(ResultCode.SUCCESS,
                I18nUtils.getSystemString(SecurityStrategyI18n.ACCOUNT_STRATEGY_UPDATE_SUCCESS));
    }
    ...
    private void addLog(String paramId, String securityStrategyName, String functionCode) {
        ...
        securityStrategyName = languageUtil.getI18nString(securityStrategyName);
        //获取日志类型
