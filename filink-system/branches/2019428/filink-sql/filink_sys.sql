...
CREATE TABLE `protocol` (
  `protocol_id` varchar(50) NOT NULL COMMENT '协议注解(uuid)',
  `protocol_name` varchar(50) DEFAULT NULL COMMENT '协议名称/类型',
  `protocol_value` varchar(255) DEFAULT NULL COMMENT '协议修改Json',
  `protocol_default_value` varchar(255) DEFAULT NULL COMMENT '协议默认Json',
  PRIMARY KEY (`protocol_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
