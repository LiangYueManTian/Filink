...
public class TaskInfoServiceImpl extends ServiceImpl<TaskInfoDao, TaskInfo> implements TaskInfoService {
    ...
    public Result addTask(ExportDto exportDto) {
        ...
        if (StringUtils.isEmpty(taskId)) {
            ...
            if (taskInfo == null) {
                return ResultUtils.warn(ExportResultCodeConstant.TASK_DOES_NOT_EXIST, I18nUtils.getString(ExportI18nConstant.TASK_DOES_NOT_EXIST));
            }
            taskInfo.setTaskStatus(TaskStatusConstant.READY);
    ...
    public Result stopTask(String taskId) {
        ...
        if (1 == integer) {
            ...
            return ResultUtils.success(ResultCode.SUCCESS, I18nUtils.getString(ExportI18nConstant.STOP_MISSION_SUCCESSFUL));
        }
        throw new FilinkExportDateBaseException();
    }
    ...
    public Result exportTaskList(QueryCondition queryCondition) {
        ...
        if (filterConditions == null) {
            return ResultUtils.warn(ExportResultCodeConstant.PARAM_NULL, I18nUtils.getString(ExportI18nConstant.PARAM_NULL));
        }
    ...
    public Result deleteTask(List<String> taskIdList) {
        ...
        if (taskInfoList == null || taskInfoList.size() == 0) {
            throw new FilinkExportDirtyDataException(I18nUtils.getString(ExportI18nConstant.TASK_DOES_NOT_EXIST));
        }
        ...
        return ResultUtils.success(ResultCode.SUCCESS, I18nUtils.getString(ExportI18nConstant.DELETE_MISSION_SUCCESSFUL));
    }
    ...
    public Boolean updateTaskFileNumById(ExportDto exportDto) {
        ...
        if (integer == 1) {
            if (flag) {
                ...
                socketMessage.setMsg(I18nUtils.getString(ExportI18nConstant.ONE_EXPORT_TASK_COMPLETED));
