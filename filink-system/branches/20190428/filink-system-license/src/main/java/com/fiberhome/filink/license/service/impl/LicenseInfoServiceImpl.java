...
//        license.setLicenseThreshold(getLicenseThresholdFromRedis());
        ...
        if (license.getTryRemark().equalsIgnoreCase(LicenseParameterValues.TRY_REMARK_YES)) {
            license.setTryRemark(I18nUtils.getString(LicenseParameterValues.TRY_REMARK_TRUE));
        } else {
            license.setTryRemark(I18nUtils.getString(LicenseParameterValues.TRY_REMARK_FALSE));
        }
        //返回给前端需要的值
