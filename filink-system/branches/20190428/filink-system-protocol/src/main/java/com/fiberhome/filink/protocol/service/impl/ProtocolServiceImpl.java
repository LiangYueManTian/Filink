...
public class ProtocolServiceImpl implements ProtocolService {
    ...
    private void addLogByType(String paramId, String type) {
        if (HTTP_PROTOCOL.getType().equals(type)) {
            addLog(paramId, I18nUtils.getString(ProtocolI18n.HTTP_PROTOCOL), ProtocolLogCode.UPDATE_HTTP_FUNCTION_CODE);
        } else if (HTTPS_PROTOCOL.getType().equals(type)) {
            addLog(paramId, I18nUtils.getString(ProtocolI18n.HTTPS_PROTOCOL), ProtocolLogCode.UPDATE_HTTPS_FUNCTION_CODE);
        } else if (WEBSERVICE_PROTOCOL.getType().equals(type)) {
            addLog(paramId, I18nUtils.getString(ProtocolI18n.WEBSERVICE_PROTOCOL), ProtocolLogCode.UPDATE_WEBSERVICE_FUNCTION_CODE);
        }
    }
    ...
    private Result generateResulByType(String type) {
        ...
        if (HTTP_PROTOCOL.getType().equals(type)) {
            result = ResultUtils.success(ProtocolResultCode.SUCCESS, I18nUtils.getString(ProtocolI18n.UPDATE_HTTP_PROTOCOL_SUCCESS));
        } else if (HTTPS_PROTOCOL.getType().equals(type)) {
            result = ResultUtils.success(ProtocolResultCode.SUCCESS, I18nUtils.getString(ProtocolI18n.UPDATE_HTTPS_PROTOCOL_SUCCESS));
        } else if (WEBSERVICE_PROTOCOL.getType().equals(type)) {
            result = ResultUtils.success(ProtocolResultCode.SUCCESS, I18nUtils.getString(ProtocolI18n.UPDATE_WEBSERVICE_PROTOCOL_SUCCESS));
        }
        return result;
    }
