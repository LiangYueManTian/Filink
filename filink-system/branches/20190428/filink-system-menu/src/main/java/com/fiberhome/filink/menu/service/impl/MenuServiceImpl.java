...
public class MenuServiceImpl implements MenuService {
    ...
    public Result queryMenuTemplateNameIsExists(MenuTemplate menuTemplate) {
        ...
        if (b) {
            return ResultUtils.success(ResultCode.SUCCESS, I18nUtils.getString(MenuI18nConstant.NAME_IS_AVAILABLE));
        }
        return ResultUtils.warn(MenuResultCodeConstant.NAME_IS_EXIST, I18nUtils.getString(MenuI18nConstant.NAME_IS_EXIST));
    }
    ...
    public Result addMenuTemplate(MenuTemplateAndMenuInfoTree menuTemplateAndMenuInfoTree) {
        ...
        if (menuInfoTreeList == null || menuInfoTreeList.size() == 0) {
            return ResultUtils.warn(MenuResultCodeConstant.PARAM_NULL, I18nUtils.getString(MenuI18nConstant.PARAM_NULL));
        }
        ...
        return ResultUtils.success(ResultCode.SUCCESS, I18nUtils.getString(MenuI18nConstant.INCREASE_DATA_SUCCESS));
    }
    ...
    public Result getMenuTemplateByMenuTemplateId(String menuTemplateId) {
        ...
        if (menuTemplate == null || ONE.equals(menuTemplate.getIsDeleted())) {
            return ResultUtils.warn(MenuResultCodeConstant.MENU_TEMPLATE_HAS_BEEN_DELETED, I18nUtils.getString(MenuI18nConstant.MENU_TEMPLATE_HAS_BEEN_DELETED));
        }
        //创建返回实体
    ...
    public Result updateMenuTemplate(MenuTemplateAndMenuInfoTree menuTemplateAndMenuInfoTree) {
        ...
        if (!version.equals(dBVersion)) {
            return ResultUtils.warn(MenuResultCodeConstant.INCONSISTENT_VERSION, I18nUtils.getString(MenuI18nConstant.INCONSISTENT_VERSION));
        }
        //查询当前模板启用状态
        ...
        if (isUsing) {
            ...
            if (ZERO.equals(templateStatus2)) {
                return ResultUtils.warn(MenuResultCodeConstant.MENU_TEMPLATE_IS_OPEN, I18nUtils.getString(MenuI18nConstant.TEMPLATE_IN_USE));
            }
        }
        //构建模板表修改实体
            ...
            if (b2) {
                ...
                if (b1) {
                    if (isUsing) {
                        ...
                        String string = I18nUtils.getString(MenuI18nConstant.USED_MENU_TEMPLATE_UPDATE);
                    ...
                    return ResultUtils.success(ResultCode.SUCCESS, I18nUtils.getString(MenuI18nConstant.UPDATE_SUCCESS));
                }
            }
        }
        return ResultUtils.warn(MenuResultCodeConstant.DIRTY_DATA, I18nUtils.getString(MenuI18nConstant.DIRTY_DATA));
    ...
    public Result deleteMenuTemplate(List<String> menuTemplateIds) {
        ...
        if (dbMenuTemplateList == null || dbMenuTemplateList.size() != menuTemplateIds.size()) {
            return ResultUtils.warn(MenuResultCodeConstant.DELETED_MENU_TEMPLATE_EXISTS, I18nUtils.getString(MenuI18nConstant.DELETED_MENU_TEMPLATE_EXISTS));
        }
        ...
        if (!menuTemplateIsOpen) {
            return ResultUtils.warn(MenuResultCodeConstant.MENU_TEMPLATE_IS_OPEN, I18nUtils.getString(MenuI18nConstant.MENU_TEMPLATE_IS_OPEN));
        }
        //默认结果
        boolean flag = true;
        //遍历模板信息 查询关联信息
        ...
        if (flag && b) {
            ...
            return ResultUtils.success(ResultCode.SUCCESS, I18nUtils.getString(MenuI18nConstant.SUCCESSFULLY_DELETED));
            //如果失败 全部回滚
        } else {
