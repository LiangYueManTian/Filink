...
import com.fiberhome.filink.cprotocol.fallback.ConnectConnectProtocolFallback;
 ...
 * @since 2019/5/31
 */
@FeignClient(name = "filink-system-server", path = "/protocol", fallback =ConnectConnectProtocolFallback.class)
