...
public class DisplaySettings {
     ...
     * 首页首次加载阈值
     */
    private Integer homeDeviceLimit;
    ...
    public boolean checkDisplay() {
        ...
        if (SystemParameterLimitEnum.SCREEN_SCROLL_TIME.checkValue(screenScrollTime)
                || SystemParameterLimitEnum.HOME_DEVICE_LIMIT.checkValue(homeDeviceLimit) ) {
            return true;
        }
        return  !DisplayTimeEnum.hasValue(timeType);
    }
