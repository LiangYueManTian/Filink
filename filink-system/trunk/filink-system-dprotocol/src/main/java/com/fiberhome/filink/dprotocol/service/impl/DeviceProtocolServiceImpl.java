...
public class DeviceProtocolServiceImpl extends ServiceImpl<DeviceProtocolDao, DeviceProtocol> implements DeviceProtocolService {
    ...
    public Result queryFileLimit() {
        ...
        //文件大小和名称长度国际化提示信息获取
        String sizeI18n = I18nUtils.getSystemString(DeviceProtocolI18n.DEVICE_PROTOCOL_FILE_SIZE);
        String nameI18n = I18nUtils.getSystemString(DeviceProtocolI18n.DEVICE_PROTOCOL_FILE_NAME);
        //替换信息中数据
    ...
    public Result addDeviceProtocol(String protocolName, MultipartFile file){
        ...
        return ResultUtils.success(ResultCode.SUCCESS, I18nUtils.getSystemString(DeviceProtocolI18n.DEVICE_PROTOCOL_ADD_SUCCESS));
    }
    ...
    public Result updateDeviceProtocol(DeviceProtocol deviceProtocol, MultipartFile file) {
        ...
        return ResultUtils.success(ResultCode.SUCCESS, I18nUtils.getSystemString(DeviceProtocolI18n.DEVICE_PROTOCOL_UPDATE_SUCCESS));
    }
    ...
    public Result deleteDeviceProtocol(List<String> protocolIds) {
        ...
        return ResultUtils.success(ResultCode.SUCCESS, I18nUtils.getSystemString(DeviceProtocolI18n.DEVICE_PROTOCOL_DELETE_SUCCESS));
    }
    ...
    private String getFileExistMsg(DeviceProtocol deviceProtocol) {
        String msg = I18nUtils.getSystemString(DeviceProtocolI18n.DEVICE_PROTOCOL_FILE_EXIST);
