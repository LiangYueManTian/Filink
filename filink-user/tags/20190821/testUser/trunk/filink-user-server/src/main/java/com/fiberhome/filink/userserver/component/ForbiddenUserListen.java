...
public class ForbiddenUserListen {
     ...
     * 启用账号禁用策略
     */
    private static final String OPEN_STRATEGY = "1";
    ...
    public void forbiddenUserListen(String code) {
        ...
        log.info("Monitored the information of kafka-forbidden User Listen,code:{}", code);
        if (USER_TASK_INFO.equals(code)) {
            ...
            if (result != null && result.getData() != null) {
                ...
                if (OPEN_STRATEGY.equals(strategy.getForbidStrategy())) {
                ...
                if (CheckEmptyUtils.collectEmpty(userIdList)) {
                    ...
                    LogUtils.addTimeTaskLog(userList, FunctionCodeConstant.FORBIDDEN_USER_MODEL, LogConstants.LOG_TYPE_SYSTEM);
                }
            }
        }
    }
