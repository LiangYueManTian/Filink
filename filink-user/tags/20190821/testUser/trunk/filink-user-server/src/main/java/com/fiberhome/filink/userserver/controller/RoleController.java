...
public class RoleController {
    ...
    public Result updateRole(@RequestBody(required = false) Role role) throws Exception {
        if (role.getId() == null) {
            return ResultUtils.warn(ResultCode.FAIL, I18nUtils.getSystemString(UserI18n.ROLE_ID_NOT_NULL));
        }
    ...
    public Result queryRoleByField(@RequestBody QueryCondition<RoleParameter> roleParamter) {
