...
public class User extends Model<User> {
    ...
    public String getTranslationUserStatus() {
        ...
        return UserConstant.START_STATUS_TIP.equals(userStatus)
    ...
    public String getTranslationLoginType() {
        ...
        String status = UserConstant.SINGLE_LOGIN_TIP.equals(this.loginType)
    ...
    public String getTranslationCountValidityTime() {
        ...
        if (StringUtils.isNotEmpty(this.countValidityTime)) {
            if (this.countValidityTime.endsWith(UserConstant.DAY_TIP)) {
            ...
            } else if (this.countValidityTime.endsWith(UserConstant.MOUNTH_TIP)) {
                return this.countValidityTime.substring(0, this.countValidityTime.length() - 1)
                        + I18nUtils.getString(ExportApiUtils.getExportLocales(),UserI18n.MOUNTH_UNIT);
            } else {
                return this.countValidityTime.substring(0, this.countValidityTime.length() - 1) + UserConstant.YEAR_UNIT;
            }
        }
