...
public interface RoleDao extends BaseMapper<Role> {
     ...
     * @return
     */
    List<Role> queryRoleByField(RoleParameter roleParamter);
     ...
     * @return
     */
    Long queryRoleNumber(RoleParameter roleParamter);
     ...
     * @return 角色id列表
     */
    List<String> queryRoleByPermissionAndDeviceType(@Param("permissionId") String permissionId,
