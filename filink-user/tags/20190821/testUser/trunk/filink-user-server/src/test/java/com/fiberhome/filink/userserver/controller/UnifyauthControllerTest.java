...
public class UnifyauthControllerTest {
    ...
    @Test
    public void queryAuthByUserAndDeviceAndDoorInfoTest() throws Exception {
    ...
    @Test
    public void queryAuthByUserAndDeviceAndDoorInfo() {
        unifyauthController.queryAuthByUserAndDeviceAndDoorInfo(new UserAuthInfo());
    }
}