...
public interface DepartmentFeign {
    ...
    public List<Department> queryDepartmentFeignById(@RequestBody List<String> ids);
    ...
    public List<Department> queryDepartmentFeignByName(@PathVariable("deptName") String deptName);
}
