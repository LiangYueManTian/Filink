...
public interface UserFeign {
    ...
    public Object queryUserByIdList(@RequestBody List<String> idList);
    ...
    public Object queryUserByDeptList(@RequestBody List<String> deptIdList);
    ...
    public Object queryUserByPhone(@PathVariable("phoneNumber") String phoneNumber);
    ...
    public Object queryOnlineUserByIdList(@RequestBody List<String> idList);
}
