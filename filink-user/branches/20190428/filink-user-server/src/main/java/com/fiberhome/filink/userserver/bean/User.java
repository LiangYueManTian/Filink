...
public class User extends Model<User> {
    ...
    public String getTranslationUserStatus() {
        ...
        return UserConst.START_STATUS_TIP.equals(userStatus) ? UserConst.START_STATUS : UserConst.START_NOT_STATUS;
    }
    ...
    public String getTranslationLoginType() {
        ...
        String status = UserConst.SINGLE_LOGIN_TIP.equals(this.loginType) ? I18nUtils.getString(UserI18n.SINGLE_LOGIN_TYPE) :
                I18nUtils.getString(UserI18n.MUITL_LOGIN_TYPE);
        return status;
    }
        ...
        if (StringUtils.isNotEmpty(this.countValidityTime)) {
            if (this.countValidityTime.endsWith(UserConst.DAY_TIP)) {
                return this.countValidityTime.substring(0, this.countValidityTime.length() - 1) +
                        I18nUtils.getString(UserI18n.DAY_UNIT);
            } else if (this.countValidityTime.endsWith(UserConst.MOUNTH_TIP)) {
                return this.countValidityTime.substring(0, this.countValidityTime.length() - 1) +
                        I18nUtils.getString(UserI18n.MOUNTH_UNIT);
            } else {
