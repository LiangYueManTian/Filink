...
public class UserServiceTestOne {
    ...
    public void getOnLineUserOne(){
        ...
        Set<String> keySet = new HashSet<>();
        keySet.add("123_1234567896548995589965657898555546464641548955558");
        ...
        new Expectations(){
            {
                RedisUtils.get("123_1234567896548995589965657898555546464641548955558");
    ...
    public void queryCurrentUser(){
        ...
        userService.queryCurrentUser("123","456");
    }
