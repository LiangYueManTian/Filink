...
public class ImportServiceImpl implements ImportService {
    ...
    public Result importUserInfo(MultipartFile file) throws IOException, InvalidFormatException {
        ...
        return ResultUtils.warn(UserConst.FILE_IS_NULL, I18nUtils.getSystemString(UserI18n.FILE_IS_NULL));
    }
    ...
    public Result checkDataFormat(User user, AccountSecurityStrategy strategy) {
        ...
        boolean userCodeMatche = user.getUserCode().matches(UserConst.USER_CODE_PATTERN);
        ...
        if (user.getAddress() != null) {
            boolean addressMatche = user.getAddress().matches(UserConst.USER_CODE_PATTERN);
            if (!addressMatche) {
                return ResultUtils.warn(ResultCode.FAIL, I18nUtils.getSystemString(UserI18n.USER_CODE_IS)
        ...
        if (user.getUserNickname() != null) {
            boolean nickNameMatch = user.getUserNickname().matches(UserConst.USER_CODE_PATTERN);
            if (!nickNameMatch) {
                return ResultUtils.warn(ResultCode.FAIL, I18nUtils.getSystemString(UserI18n.USER_CODE_IS)
        ...
        if (user.getUserName() != null) {
            boolean userNameMatch = user.getUserName().matches(UserConst.USER_CODE_PATTERN);
            if (!userNameMatch) {
                return ResultUtils.warn(ResultCode.FAIL, I18nUtils.getSystemString(UserI18n.USER_CODE_IS)
        ...
        if (user.getUserDesc() != null) {
            boolean userDescMatch = user.getUserDesc().matches(UserConst.USER_CODE_PATTERN);
            if (!userDescMatch) {
                return ResultUtils.warn(ResultCode.FAIL, I18nUtils.getSystemString(UserI18n.USER_CODE_IS)
    ...
    public Result batchAddUser(List<User> userList) {
        ...
        userList.forEach(user -> {
            ...
            user.setCreateTime(FiLinkTimeUtils.getUtcZeroTimeStamp());
    ...
    private Result checkDataNull(Row row) {
        ...
        if (userCodeCell == null || getCellType(userCodeCell) == Cell.CELL_TYPE_BLANK) {
            return ResultUtils.warn(UserConst.USER_CODE_NULL, I18nUtils.getSystemString(UserI18n.USER_CODE_NULL));
        } else {
        ...
        if (userNameCell == null || getCellType(userNameCell) == Cell.CELL_TYPE_BLANK) {
            return ResultUtils.warn(UserConst.USER_NAME_NULL, I18nUtils.getSystemString(UserI18n.USER_NAME_NULL));
        } else {
        ...
        if (userStatusCell == null || getCellType(userStatusCell) == Cell.CELL_TYPE_BLANK) {
            return ResultUtils.warn(UserConst.USER_STATUS_NULL, I18nUtils.getSystemString(UserI18n.USER_STATUS_NULL));
        } else {
        ...
        if (departmentCell == null || getCellType(departmentCell) == Cell.CELL_TYPE_BLANK) {
            return ResultUtils.warn(UserConst.USER_DEPT_NULL, I18nUtils.getSystemString(UserI18n.USER_DEPT_NULL));
        } else {
        ...
        if (roleCell == null || getCellType(roleCell) == Cell.CELL_TYPE_BLANK) {
            return ResultUtils.warn(UserConst.USER_ROLE_NULL, I18nUtils.getSystemString(UserI18n.USER_ROLE_NULL));
        } else {
        ...
        if (loginTypeCell == null || getCellType(loginTypeCell) == Cell.CELL_TYPE_BLANK) {
            return ResultUtils.warn(UserConst.USER_MODEL_NULL, I18nUtils.getSystemString(UserI18n.USER_MODEL_NULL));
        } else {
        ...
        if (phoneNumberCell == null || getCellType(phoneNumberCell) == Cell.CELL_TYPE_BLANK) {
            return ResultUtils.warn(UserConst.PHONE_NUMBER_NULL, I18nUtils.getSystemString(UserI18n.PHONE_NUMBER_NULL));
        } else {
        ...
        if (emailCell == null || getCellType(emailCell) == Cell.CELL_TYPE_BLANK) {
            return ResultUtils.warn(UserConst.EMAIL_NULL, I18nUtils.getSystemString(UserI18n.EMAIL_NULL));
        } else {
        ...
        if (remarkCell != null) {
            ...
            if (remark.length() >= UserConst.MAX_USER_DESC_LENGTH) {
                return ResultUtils.warn(UserConst.USER_DESC_TOO_LONG, I18nUtils.getSystemString(UserI18n.USER_DESC_TOO_LONG));
            }
        }
        ...
        if (addressCell != null) {
            ...
            if (address.length() > UserConst.MAX_USER_ADDRESS_LENGTH) {
                return ResultUtils.warn(UserConst.USER_ADDRESS_TOLONG, I18nUtils.getSystemString(UserI18n.USER_ADDRESS_TOLONG));
            }
        }
        ...
        if (validataCell != null && getCellType(validataCell) != Cell.CELL_TYPE_BLANK) {
            ...
            if (StringUtils.isNotEmpty(validay)) {
                ...
                if (validataType != Cell.CELL_TYPE_NUMERIC) {
                    return ResultUtils.warn(UserConst.VALIDATA_TIME_ABNORMAL_FORMAT,
        ...
        if (maxNumCell != null) {
            ...
            if (maxNumType != Cell.CELL_TYPE_NUMERIC) {
                return ResultUtils.warn(UserConst.MAX_USER_NUMBER_ABNORMAL_FORMAT,
