...
public class UserServiceTestOne {
    ...
    public void forceOffline(){
        ...
        idMap.put(UserConst.USER_PREFIX + "1||2","456");
        ...
        idMap.remove(UserConst.USER_PREFIX + "1||2");
        idMap.put(UserConst.USER_PREFIX + "12||23","456");
    ...
    public void logout(){
        new Expectations(){
            {
                RedisUtils.remove(UserConst.USER_PREFIX + "123||456");
                result = null;
            }
        };
