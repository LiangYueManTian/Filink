    ...
    public void validateUserLogin() throws Exception {
        ...
        new Expectations() {
            {
                ...
                loginSysInfoFeign.queryLoginSysInfo((LoginSysParam)any);
        ...
        new Expectations() {
            {
                ...
                currentLicense.beginTime="2017-10-01";
        ...
        new Expectations() {
            {
                ...
                LoginSysInfo loginSysInfo = new LoginSysInfo();
                loginSysInfo.setCurrentLicense(currentLicense);
                loginSysInfo.setSecurityStrategyResult(objectResult);
                result = loginSysInfo;
            }
        };
        ...
        new Expectations() {
            {   License currentLicense = new License();
                ...
                currentLicense.beginTime="2017-10-01";
                currentLicense.maxOnlineNum = "2";
                Result objectResult2 = new Result<>();
                loginSysInfoFeign.queryLoginSysInfo((LoginSysParam)any);
                LoginSysInfo loginSysInfo = new LoginSysInfo();
                loginSysInfo.setCurrentLicense(currentLicense);
                Result objectResult = new Result<>();
                loginSysInfo.setSecurityStrategyResult(objectResult);
                loginSysInfo.setIpResult(objectResult2);
...
//        };
        ...
        new Expectations() {
            {
                ...
                userKeys.add("USER_123redis_split123");
                RedisUtils.keys(anyString);
                result = userKeys;
            }
        };
    ...
    public void queryPhoneIdByUserIds() throws Exception {
        ...
        new Expectations() {
            {
                User user = new User();
                user.setPushId("USER_123redis_split123");
                RedisUtils.get(anyString);
                result = user;
            }
        };
    ...
    public void queryOnlineUserByIdList() throws Exception {
        ...
        new Expectations() {
            {
                Set<String> tokenKey = new HashSet<>();
                tokenKey.add("123redis_split123");
                RedisUtils.keys(anyString);
                result = tokenKey;
            }
        };
