...
public class DepartmentControllerTest {
    ...
    @Test
    public void queryDepartmentFeignByName() {
        departmentController.queryDepartmentFeignByName("test");
    }

    @Test
    public void queryDepartTreeByDeptId() {
        departmentController.queryDepartTreeByDeptId("test");
    }

    @Test
    public void queryDepartTree() {
        departmentController.queryDepartTree("test");
    }
