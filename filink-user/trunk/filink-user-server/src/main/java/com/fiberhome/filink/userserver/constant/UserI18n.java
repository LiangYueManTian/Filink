...
public class UserI18n {
     ...
     * 用户名称不在指定长度之间
     */
    public static final String USER_NAME_OUT_RANGE = "USER_NAME_OUT_RANGE";
     ...
     * 光交箱
     */
    public static final String G_J_X_NAME = "G_J_X_NAME";

    /**
     * 电子锁
     */
    public static final String D_Z_S_NAME = "D_Z_S_NAME";

    /**
     * 智能标签
     */
    public static final String Z_N_B_Q_NAME = "Z_N_B_Q_NAME";

    /**
     * 人井
     */
    public static final String R_J_NAME = "R_J_NAME";

    /**
     * 人井的电子锁
     */
    public static final String R_J_D_Z_S_NAME = "R_J_D_Z_S_NAME";

    /**
     * 配线架
     */
    public static final String P_X_J_NAME = "P_X_J_NAME";

    /**
     * 配线架智能标签
     */
    public static final String P_X_J_Z_N_B_Q_NAME = "P_X_J_Z_N_B_Q_NAME";

    /**
     * 接头盒
     */
    public static final String J_T_H_NAME = "J_T_H_NAME";

    /**
     * 接头盒智能标签
     */
    public static final String J_T_H_Z_N_B_Q_NAME = "J_T_H_Z_N_B_Q_NAME";

    /**
     * 室外柜
     */
    public static final String S_W_G_NAME = "S_W_G_NAME";

    /**
     * 室外柜电子锁
     */
    public static final String S_W_G_D_Z_S_NAME = "S_W_G_D_Z_S_NAME";
     ...
     * 未开启状态
     */
    public static final String START_NOT_STATUS = "START_NOT_STATUS";
    /**
     * 导入用户角色不能为超级管理员
     */
    public static final String IMPORT_USER_ROLE_CANNOT_BE_SUPER_ADMINISTRATOR = "IMPORT_USER_ROLE_CANNOT_BE_SUPER_ADMINISTRATOR";
    /**
     * 不支持的用户登陆模式
     */
    public static final String UNSUPPORTED_USER_LOGIN_TYPE = "UNSUPPORTED_USER_LOGIN_TYPE";
    /**
     * 不支持的用户状态
     */
    public static final String UNSUPPORTED_USER_STATUS = "UNSUPPORTED_USER_STATUS";
    /**
     * 已经过期的授权无法更改状态
     */
    public static final String AUTHORIZATION_THAT_HAS_EXPIRED_CANNOT_CHANGE_STATUS = "AUTHORIZATION_THAT_HAS_EXPIRED_CANNOT_CHANGE_STATUS";
    /**
     * 发送短信失败
     */
    public static final String FAILED_SEND_SMS = "FAILED_SEND_SMS";
}
