...
public class UserParameter implements Serializable {
    ...
    public String getSortProperties() {
        if (StringUtils.isEmpty(this.sortProperties)) {
            return null;
        }
        char[] chars = this.sortProperties.toCharArray();
     ...
     * @return
     */
    public String alterLikeValue(String value) {
        if (value == null) {
            return null;
        }
        value = value.replace("\\", "\\\\");
     ...
     * @return
     */
    public String alterLoginValue(String value) {
        if (value == null) {
            return null;
        }
        value = value.replace("\\", "\\\\");
