...
# author yaoyuan
# desc: 构建docker镜像
_jarPath=/root/.jenkins/workspace/filink-user/filink-user-server/target/filink-user-server-0.0.1-RELEASE.jar
_imageName=filink-user-server
_imageTag=filink-user
_projectName=filink-user
if [[ -f ${_jarPath} ]]
