...
public class SmsCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    private void validate(ServletWebRequest request) throws ServletRequestBindingException {
        ...
        String smsCode = ServletRequestUtils.getStringParameter(request.getRequest(), LoginConstant.SMS_CODE);
        String phoneNumber = ServletRequestUtils.getStringParameter(request.getRequest(), LoginConstant.LOGIN_BY_PHONE);
