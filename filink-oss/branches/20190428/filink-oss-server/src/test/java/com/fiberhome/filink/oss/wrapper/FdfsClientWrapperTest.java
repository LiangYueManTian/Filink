...
import com.fiberhome.filink.oss.FilinkOssServerApplication;
...
public class FdfsClientWrapperTest {
    ...
    public void setUp() throws IOException {
        ...
        storePath = new StorePath("group1", "M00/00/00/hakjdhakjshdklawiadhk.xml");
        url =  "group1/M00/00/00/hakjdhakjshdklawiadhk.xml";
     ...
     */
    @Test
    public void uploadFileStreamTest() {
        new Expectations() {
            {
                storageClient.uploadFile((InputStream) any, anyLong, anyString, null);
                result = storePath;
     ...
     */
    @Test
    public void getThumbImagePathTest() {
        new Expectations() {
            {
