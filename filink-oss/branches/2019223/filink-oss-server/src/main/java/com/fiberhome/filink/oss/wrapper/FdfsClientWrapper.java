...
public class FdfsClientWrapper {
     ...
     * @return 存储路径
     */
    public String uploadFileImage(InputStream is, long size, String fileExtension, Set<MateData> metaData) {
        StorePath path = storageClient.uploadImageAndCrtThumbImage(is, size, fileExtension, metaData);
        return getResAccessUrl(path);
    }
    ...
    private String getResAccessUrl(StorePath storePath) {
        return basePath + storePath.getFullPath();
    }
