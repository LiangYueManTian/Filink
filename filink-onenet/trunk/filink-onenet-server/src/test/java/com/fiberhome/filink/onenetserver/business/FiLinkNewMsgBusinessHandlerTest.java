...
public class FiLinkNewMsgBusinessHandlerTest {
    ...
    public void before() {
        ...
        tmpDirPath = "D:\\fiberhome\\filink\\test\\";
        zipPassword = "FiLink";
    ...
    public void handleMsgParamUploadTest() {
        ...
        dataMap.put(OneNetParamsKey.IMEI,"3564534564");
        dataMap.put(OneNetParamsKey.APP_ID,"415343545");
    ...
    public void handleMsgActiveTest() {
        ...
        upgradeConfigTmp.setSoftwareVersion("RP9003.004B.bin");
        new Expectations(RedisUtils.class) {
            {
                RedisUtils.hGet(RedisKey.CMD_TIME, anyString);
                result = null;
                ...
                RedisUtils.get("oneNetUpgradeFilePrefixRP9003");
        ...
        new Expectations(RedisUtils.class) {
            {
                ...
                systemLanguageUtil.getI18nString(OneNetI18n.OPEN_LOCK_MSG);
                result = "锁${num}";
        ...
        new Expectations(RedisUtils.class) {
            {
                ...
                RedisUtils.hasKey(anyString);
                result = false;
                systemLanguageUtil.getI18nString(OneNetI18n.CLOSE_LOCK_MSG);
                result = "锁${num}";
        ...
        new Expectations(RedisUtils.class) {
            {
                ...
                RedisUtils.hasKey(anyString);
                result = false;
                systemLanguageUtil.getI18nString(OneNetI18n.OPEN_DOOR_MSG);
                result = "门开${num}";
                systemLanguageUtil.getI18nString(OneNetI18n.CLOSE_DOOR_MSG);
                result = "门关${num}";
