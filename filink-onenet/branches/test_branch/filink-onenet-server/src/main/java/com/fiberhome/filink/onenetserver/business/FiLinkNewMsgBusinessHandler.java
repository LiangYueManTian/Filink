...
//        }
    ...
    private void updateControlActiveStatus(ControlParam control) {
        ...
        if (Constant.SLEEP_STATUS.equals(activeStatus)) {
            //更新主控激活状态为激活
    ...
    private void resolveData(String equipmentId, ControlParam controlParam, Integer serialNumber, Map<String, Object> dataSource) {
        ...
        try {
            ...
            e.printStackTrace();
            log.error("get current file " + continuePackageNum + " data failed>>>");
            return;
        }
        //获取crc
    ...
    private void resolveUpgradeSuccess(ControlParam control, Map<String, Object> dataSource,
        ...
        //todo 升级测试代码
        PerformanceTest.setUpgradeTime(equipmentId, "upgradeSuccessDeviceTime", currentTime);
        ...
        switch (upgradeType) {
            case Constant.PDA_UPGRADE:
                upgradeTypeMsg = systemLanguageUtil.getI18nString(OneNetI18n.PDA_UPGRADE);
                break;
            case Constant.PLATFORM_UPGRADE:
                upgradeTypeMsg = systemLanguageUtil.getI18nString(OneNetI18n.PLATFORM_UPGRADE);
                break;
            case Constant.OCEAN_CONNECT_UPGRADE:
                upgradeTypeMsg = systemLanguageUtil.getI18nString(OneNetI18n.OCEAN_CONNECT_UPGRADE);
                break;
            case Constant.ONE_NET_UPGRADE:
                upgradeTypeMsg = systemLanguageUtil.getI18nString(OneNetI18n.ONE_NET_UPGRADE);
                break;
            default:
        ...
        if (Constant.UPGRADE_SUCCESS.equals(upgradeResult)) {
            upgradeResultMsg = systemLanguageUtil.getI18nString(OneNetI18n.UPGRADE_SUCCESS);
        } else {
            upgradeResultMsg = systemLanguageUtil.getI18nString(OneNetI18n.UPGRADE_FAIL);
        }
...
//        }
    ...
    private void mergePic(String equipmentId, String index, int packageSum, Map<String, Object> picMap, String deviceId) {
        ...
        //todo 图片测试
        PerformanceTest.setPicTime(equipmentId, "mergeEndTime", System.currentTimeMillis());
    }
    ...
    private void resolveDoorStateChange(ControlParam controlParam, Map<String, Object> dataSource,
        ...
        if (Constant.OPEN_STATE.equals(doorState)) {
            setRemarks(deviceLog, doorNum, systemLanguageUtil.getI18nString(OneNetI18n.OPEN_DOOR_MSG));
        } else {
            setRemarks(deviceLog, doorNum, systemLanguageUtil.getI18nString(OneNetI18n.CLOSE_DOOR_MSG));
        }
        //设置时间
    ...
    private void resolveCloseLockUpload(ControlParam controlParam, Map<String, Object> dataSource,
        ...
        //拼接附加信息
        setRemarks(deviceLog, lockNum, systemLanguageUtil.getI18nString(OneNetI18n.CLOSE_LOCK_MSG));
        //设置时间
        deviceLog.setCurrentTime(time);
        saveDeviceLog(deviceLog, DeviceLogType.EVENT,
    ...
    private void resolveUnlockResponse(Map<String, Object> dataSource, String equipmentId, Integer serialNumber) {
        ...
        if (paramList != null && paramList.size() > 0) {
            ...
            String msg = systemLanguageUtil.getI18nString(OneNetI18n.UNLOCK_RESULT);
    ...
    private String getUnlockResultString(String slotNum, String result) {
        ...
        switch (result) {
            ...
            case LockResult.SUCCESS:
                unlockMsg = systemLanguageUtil.getI18nString(OneNetI18n.UNLOCK_SUCCESS);
                suffix = slotNum + ":" + unlockMsg + ",";
                break;
            case LockResult.KEY_NOT_CONFIG:
                unlockMsg = systemLanguageUtil.getI18nString(OneNetI18n.UNLOCK_KEY_NOT_CONFIG);
                suffix = slotNum + ":" + unlockMsg + ",";
                break;
            case LockResult.PARAMETER_ERROR:
                unlockMsg = systemLanguageUtil.getI18nString(OneNetI18n.UNLOCK_PARAMETER_ERROR);
                suffix = slotNum + ":" + unlockMsg + ",";
                break;
            case LockResult.LOCK_ON:
                unlockMsg = systemLanguageUtil.getI18nString(OneNetI18n.UNLOCK_LOCK_ON);
                suffix = slotNum + ":" + unlockMsg + ",";
                break;
            case LockResult.ACTIVE_CODE_ERROR:
                unlockMsg = systemLanguageUtil.getI18nString(OneNetI18n.UNLOCK_ACTIVE_CODE_ERROR);
                suffix = slotNum + ":" + unlockMsg + ",";
                break;
            case LockResult.LOCK_NOT_CONFIG:
                unlockMsg = systemLanguageUtil.getI18nString(OneNetI18n.UNLOCK_LOCK_NOT_CONFIG);
                suffix = slotNum + ":" + unlockMsg + ",";
                break;
            case LockResult.OTHER:
                unlockMsg = systemLanguageUtil.getI18nString(OneNetI18n.UNLOCK_OTHER);
                suffix = slotNum + ":" + unlockMsg + ",";
                break;
            case LockResult.REPEAT_CMD:
                unlockMsg = systemLanguageUtil.getI18nString(OneNetI18n.UNLOCK_REPEAT_CMD);
                suffix = slotNum + ":" + unlockMsg + ",";
                break;
            case LockResult.STOP:
                unlockMsg = systemLanguageUtil.getI18nString(OneNetI18n.UNLOCK_STOP);
                suffix = slotNum + ":" + unlockMsg + ",";
                break;
            default:
    ...
    private void pushAppMsg(UnlockPushBean pushBean) {
        ...
        pushBean.setTitle(systemLanguageUtil.getI18nString(OneNetI18n.UNLOCK_TITLE));
        //app推送
    ...
    private void resolveSleep(ControlParam control, Map<String, Object> dataSource,
        ...
        //保存设施日志
        saveDeviceLog(deviceLog, DeviceLogType.EVENT,
                systemLanguageUtil.getI18nString(DeviceLogNameI18n.SLEEP_EVENT), DeviceEventType.SLEEP_EVENT);
        //判断时间是否需要处理
    ...
    private void resolveOpenLockUpload(ControlParam control, Map<String, Object> dataSource, DeviceLog deviceLog,
        ...
        String lockNum = dataSource.get(ParamsKey.LOCK_NUM).toString();
        //拼接附加信息
        setRemarks(deviceLog, lockNum, systemLanguageUtil.getI18nString(OneNetI18n.OPEN_LOCK_MSG));
        //设置日志信息
        deviceLog.setCurrentTime(time);
        saveDeviceLog(deviceLog, DeviceLogType.EVENT,
        ...
        //判断是否需要处理
        if (isNeedToResolve(equipmentId, CmdId.PARAMS_UPLOAD, time)) {
    ...
    private void resolveActive(String equipmentId, ControlParam control,
        ...
        //保存设施日志
        saveDeviceLog(deviceLog, DeviceLogType.EVENT,
                systemLanguageUtil.getI18nString(DeviceLogNameI18n.ACTIVE_EVENT), DeviceEventType.ACTIVE_EVENT);
