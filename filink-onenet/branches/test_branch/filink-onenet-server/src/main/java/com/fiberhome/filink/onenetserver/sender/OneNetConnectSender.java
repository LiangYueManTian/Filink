...
public class OneNetConnectSender extends AbstractInstructSender {
    ...
    protected void send(AbstractReqParams abstractReqParams, String data) {
        if (abstractReqParams instanceof FiLinkOneNetConnectParams) {
            FiLinkOneNetConnectParams oceanConnectParams = (FiLinkOneNetConnectParams) abstractReqParams;
    ...
    protected String getReqData(AbstractReqParams abstractReqParams) {
        FiLinkOneNetConnectParams fiLinkReqOceanConnectParams;
        try {
            fiLinkReqOceanConnectParams = (FiLinkOneNetConnectParams) abstractReqParams;
        } catch (Exception e) {
        ...
        if (CmdType.REQUEST_TYPE == fiLinkReqOceanConnectParams.getCmdType()) {
            ...
            dataMap.put(OneNetParamsKey.IMEI, fiLinkReqOceanConnectParams.getImei());
            dataMap.put(OneNetParamsKey.APP_ID, fiLinkReqOceanConnectParams.getAppId());
